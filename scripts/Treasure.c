...
sld = GetCharacter(NPC_GenerateCharacter("GhostCapt", "Vaterskeletcap", "Skeleton", "man", iRank, PIRATE, -1, true, "quest"));
sld.name 	= "Дэйви";
sld.lastname = "Джонс";
...
sld.money = 6666666;
sld.GenQuest.CrewVaterSkelMode  = true;
...
TakeNItems(sld, "icollection", 7);
TakeNItems(sld, "chest_open", 1);
TakeNItems(sld, "cannabis7", 1); // мангароса
TakeNItems(sld, "BackPack3", 1);

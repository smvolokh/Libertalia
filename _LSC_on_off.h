...
#define VERSION_NUMBER1       "Libertalia " // Корсары: ККС + ГПК modding base #1
#define VERSION_NUMBER2       "ver. 0.1.3.1. (02.09.2022). Pre-alpha release. work in progress. 
BlackSailsTeam."
#define VERSION_NUMBER3       "Корсары: ККС + Absolum + ГПК + CSP + ТДМ + other modding base"
...
//GetEngineVersion();  Долой СтарФорс!=)

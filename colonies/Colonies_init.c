...
void InitColonies()
{
	...
	///////////////////////////////////////////////////////////////////// 
		...
		Colonies[n].islandLable = "PuertoRico";
		colonies[n].num = 1;
		colonies[n].map.x = 1305;
		colonies[n].map.y = 620;
		colonies[n].StoreNum   = VillaAlegria_STORE;
		colonies[n].from_sea   = "VillaAlegria_town";
		colonies[n].Default.BoardLocation = "VillaAlegria_ExitTown";
		colonies[n].FortValue = 75; // homo
...
///////////////////////////////////////////////////////////////////// 
	...
	///////////////////////////////////////////////////////////////////// 
		...
		Colonies[n].islandLable = "Jamaica";
		colonies[n].num = 1;
		colonies[n].map.x = 940;
		colonies[n].map.y = 410;
		colonies[n].StoreNum   = PortAntonio_STORE;
		colonies[n].HasNoFort = true;
		colonies[n].from_sea   = "PortAntonio_town";
		colonies[n].Default.BoardLocation = "PortAntonio_ExitTown";
		colonies[n].HasNoFort = true;
	...
	//////////////////////////////
		...
		Colonies[n].islandLable = "Jamaica";
		Colonies[n].num = "1";
		colonies[n].map.x = 650;
		colonies[n].map.y = 1090;
	...
	///////////////////////////////////////////////////////////////////// 
		...
		colonies[n].HasNoFort = true;
		colonies[n].StoreNum   = Vestpunt_STORE;
		colonies[n].HasNoFort = true;
		colonies[n].from_sea   = "Vestpunt_port";
		colonies[n].Default.BoardLocation = "Vestpunt_ExitTown";
...
///////////////////////////////////////////////////////////////////// 
	...
	///////////////////////////////////////////////////////////////////// 
		...
		colonies[n].StoreNum   = SantLous_STORE;
		colonies[n].from_sea   = "SantLous_Port";
		colonies[n].HasNoFort = true;
		colonies[n].from_sea   = "SantLous_port";
		colonies[n].Default.BoardLocation = "SantLous_ExitTown";
			///////////////////////////////////////////////////////////////////// 
	...
	///////////////////////////////////////////////////////////////////// 
		...
		colonies[n].FortValue = 80; // homo
		colonies[n].jail = 0; // тюрьма Форт де Франса всегда образцовая. нужно по квесту Шарля.
	...
	///////////////////////////////////////////////////////////////////// 
		...
		Colonies[n].islandLable = "Hispaniola";
		colonies[n].num = 1;
		colonies[n].map.x = 519;
		colonies[n].map.y = 327;
		colonies[n].StoreNum   = LeKe_STORE;
		colonies[n].HasNoFort = true;
		colonies[n].from_sea   = "LeKe_town";
	...
	/////////////////////////////////////////////////////////////////////
	/// DestinyGiftPearl (Mein)
	/////////////////////////////////////////////////////////////////////
		n = n + 1;
		Colonies[n].id = "DestinyGiftPearl";
		Colonies[n].visible = false;
		Colonies[n].smuggling_nation = "none";
		Colonies[n].nation = "none";
		Colonies[n].island = "DestinyGiftPearl";
		Colonies[n].islandLable = "DestinyGiftPearl";
		colonies[n].num = 1;
		colonies[n].map.x = 1370;
		colonies[n].map.y = 505;
		colonies[n].StoreNum   = Pirates_STORE; // заглушка
	...
	/////////////////////////////////////////////////////////////////////
	/// Tenotchitlan_1 (Mein Теночтитлан)
	/////////////////////////////////////////////////////////////////////
		n = n + 1;
		Colonies[n].id = "Tenotchitlan_1";
		Colonies[n].visible = false;
		Colonies[n].smuggling_nation = "none";
		Colonies[n].nation = "none";
		Colonies[n].island = "Tenotchitlan_1";
		Colonies[n].islandLable = "Tenotchitlan_1";
		colonies[n].num = 1;
		colonies[n].map.x = 1370;
		colonies[n].map.y = 505;
		colonies[n].StoreNum   = Pirates_STORE; // заглушка
	...
	///////////////////////////////////////////////////////////////////// 
		n = n + 1;
		Colonies[n].id = "Roseau";
		Colonies[n].visible = true;
		Colonies[n].smuggling_nation = PIRATE;
		Colonies[n].nation = PIRATE;
		Colonies[n].island = "Dominica";
		Colonies[n].islandLable = "Dominica";
		Colonies[n].num = "1";
		colonies[n].map.x = 1595;
		colonies[n].map.y = 1250;
		colonies[n].HasNoFort = true;
		colonies[n].StoreNum   = Roseau_STORE;
		colonies[n].HasNoFort = true;
		colonies[n].from_sea   = "Roseau_port";
		colonies[n].Default.BoardLocation = "Roseau_ExitTown";
		colonies[n].HasNoFort = true;
...
//========================= необитайки ==================================
	...
	/////////////////////////////////////////////////////////////////////
		n = n + 1;
		Colonies[n].id = "LostShipsCityy";
		Colonies[n].visible = false;
		Colonies[n].smuggling_nation = "none";
		Colonies[n].nation = "none";
		Colonies[n].island = "LostShipsCityy";
		Colonies[n].islandLable = "LostShipsCityy";
		Colonies[n].num = "1";
		colonies[n].map.x = 1605;
		colonies[n].map.y = 1852;
		colonies[n].StoreNum   = Pirates_STORE; // заглушка
		colonies[n].from_sea   = "LostShipsCityy_town";
		colonies[n].HasNoFort = true;

	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			if (CheckAttribute(pchar, "questTemp.Terrapin") && pchar.questTemp.Terrapin == "done")
			{
				...
				link.l1 = "Теперь я могу получить от вас письменный приказ, согласно которому Мишель будет освобожден из-под ареста?";
				link.l1.go = "serve";
			...
			if (CheckAttribute(pchar, "questTemp.Guardoftruth") && GetCharacterIndex("Noel") == -1 && pchar.questTemp.Patria != "epizode_12_barondie" && pchar.questTemp.Patria != "epizode_12_baronfail" && pchar.questTemp.Patria != "epizode_12_baronkilled" && pchar.questTemp.Patria != "fail" && pchar.questTemp.Patria != "end")
			{
				...
				{
					dialog.text = "Рад вас видеть, "+pchar.name+". Прежде всего позвольте вас поздравить с успешно выполненным сложнейшим заданием по защите колонии Форт де Франса от испанских захватчиков. Вы блестяще справились, мой друг!";
				...
				{
					dialog.text = "Рад вас видеть, "+pchar.name+". Прежде всего позвольте вас поздравить с успешно выполненным сложнейшим заданием по защите колонии Форт де Франса от испанских захватчиков. Вы блестяще справились, мой друг! И поэтому я даю вам еще одну возможность поступить на службу в военно-морской флот. Такие офицеры нужны Франции. Надеюсь, в этот раз вы будете более благоразумным... Возьмите патент, капитан "+pchar.name+"!";
			...
			if (CheckAttribute(pchar, "questTemp.Patria") && pchar.questTemp.Patria != "fail" && pchar.questTemp.Patria != "end")
			{
				if (!CheckCharacterItem(pchar, "patent_fra"))
				{
					dialog.text = ""+pchar.name+", вы меня огорчили. В результате ваших необдуманных поступков вы лишились патента и звания в королевском флоте. О дальнейшей работе не может быть и речи. Можете быть свободны.";
					link.l1 = "Гм...";
				...
				{
					dialog.text = "Итак, с прибытием, "+pchar.name+". Докладывайте!";
				...
				{
					dialog.text = TimeGreeting()+", "+pchar.name+". Как обстоят дела у минхера Стайвесанта?";
				...
				{
					dialog.text = ""+pchar.name+", барон... Вы уже вернулись?";
					link.l1 = "...";
				...
				{
					dialog.text = "Не нравится мне ваш хмурый вид, "+pchar.name+". Что сказал Стайвесант, докладывайте!";
				...
				if (pchar.questTemp.Patria == "epizode_7_continue" && pchar.location.from_sea == "Charles_town") // add-7
				{
					...
					{
						dialog.text = "У вас ко мне какие-то вопросы, "+pchar.name+"?";
				...
				{
					dialog.text = "Капитан, наконец-то вы прибыли! Чрезвычайная ситуация в Капстервиле!";
				...
				{
					dialog.text = "Капитан "+pchar.name+", сэр Дойли! Рад вас видеть! Весь город наблюдал за тем, как вы преподали урок испано-голландским негодяям, посягнувшим на нашу колонию!";
				...
				{
					dialog.text = TimeGreeting()+", "+pchar.name+". Итак, приступим к делу?";
				...
				{
					dialog.text = ""+pchar.name+", вы слышали о бароне? Его захватили пираты...";
				...
				{
					dialog.text = ""+pchar.name+", как ваши успехи? Мне докладывали, что барон поднялся к вам на борт...";
		...
		case "Puancie_Jail":
			dialog.text = "Добрый день, "+pchar.name+". Позвольте представиться - Филипп де Пуанси, и я...";
			link.l1 = "Какого черта меня задержали и посадили в тюрьму? Это форменное безобразие! Я ни в чём не виновен, и...";
			link.l1.go = "Puancie_Jail_1";			
		break;
		
		case "Puancie_Jail_1":
			dialog.text = "Сударь, я попрошу вас не перебивать меня! Вы разговариваете с генерал-губернатором французских колоний Карибского архипелага! Я прощаю ваш дерзкий тон лишь потому, что вы не могли знать, кто стоит перед вами. Но я рекомендовал бы вам впредь быть более сдержанным.";
			link.l1 = "Хм... Простите, ваша светлость.";
			link.l1.go = "Puancie_Jail_2";			
		break;
		
		case "Puancie_Jail_2":
			dialog.text = "Так-то лучше. Что касается вашего вопроса - то вас по ошибке приняли за шпиона и поместили под арест до выяснения. В последнее время враги Франции активизировали свою деятельность в французских поселениях, поэтому я лично издал приказ задерживать всех подозрительных людей\nНо сейчас во всем разобрались - вы действительно "+GetFullName(pchar)+", и я лично, подчеркиваю - лично явился в эти казематы, чтобы выпустить вас на свободу. А вы кричите и ведете себя, словно мальчишка!";
			link.l1 = "Еще раз приношу извинения, ваша светлость. Так я свободен?";
			link.l1.go = "Puancie_Jail_3";			
		break;
		
		case "Puancie_Jail_3":
			dialog.text = "Да, вы свободны. Но прежде чем сержант отопрет двери вашей камеры, мы с вами поговорим по душам. Зачем Вы ищите Мишеля де Монпе?";
			link.l1 = "Я невольно взял на себя обязательства доставить Мишелю весть о гибели его брата, Шарля де Мора и лично перадать Мишелю вещи Шарля...";
			link.l1.go = "Puancie_Jail_4";			
		break;
		
		case "Puancie_Jail_4":
			dialog.text = "Хм... Понимаете, у месье де Монпе серьезные неприятности. Шарль вызвался решить проблемы своего брата, но... Он погиб. И если Вы, вдруг, решите взять на себя обязательства покойного Шарля, то можете рассчитывать на мою благосклонность..";
			link.l1 = "Месье, я лишь хочу исполнить последнюю волю умершего и закрыть поскорее эту историю...";
			link.l1.go = "Puancie_Jail_5";			
		break;
		
		case "Puancie_Jail_5":
			dialog.text = "Подумайте хорошенько, "+GetFullName(pchar)+", благоволение генерал-губернатора французский колоний в Карибском Море дорого стоит, не находите? Подумайте нам моими словами.";
			link.l1 = "Хорошо, я обязательно подумаю... Но где я могу найти Мишеля?";
			link.l1.go = "Puancie_Jail_6";			
		break;
		
		case "Puancie_Jail_6":
			dialog.text = "Мишель де Монпе содержится под арестом в подземной базе Форт де Франса, принадлежащей Мальтийскому Ордену. Если решите помочь Мишелю, то я разрешаю вам неограниченное число раз посещать базу, и беседовать с Мишелем столько, сколько вы сами сочтете нужным. Офицеры и солдаты Ордена ознакомлены с моим распоряжением и не будут чинить вам препятствий. ";
			link.l1 = "Где же находится эта подземная база?";
			link.l1.go = "Puancie_Jail_7";			
		break;
		
		case "Puancie_Jail_7":
			dialog.text = "В Форт де Франсе, конечно. Найдите большое здание городских казарм и войдите в дверь, на которую нанесена символика Ордена. Затем спуститесь по ступеням вниз, на второй подземный ярус к казематам. Там и отыщете месье де Монпе в одной из камер. На этом все. Надеюсь, мы еще с вами встретимся, "+GetFullName(pchar)+". Сержант!";
			link.l1 = "Постойте, ваша светлость! А... мои вещи? Шпага, и прочее?..";
			link.l1.go = "Puancie_Jail_8";			
		break;
		
		case "Puancie_Jail_8":
			dialog.text = "Ваши вещи конфискованы в пользу города Форт де Франс. Всего доброго!";
			link.l1 = "Но...";
		...
		case "saga":
			...
			dialog.text = "А-а, вот и сам "+GetFullName(pchar)+" собственной персоной! Очень, очень рад вас видеть. Вы, вероятно, явились обсудить со мной судьбу Мишеля?";
		...
		case "saga_1":
			...
			dialog.text = "Замечательно! Я принимаю у вас эти деньги. Вы показали себя с наилучшей стороны, "+pchar.name+"!";
			link.l1 = "Когда я смогу получить приказ об освобождении Мишеля де Монпе?";
			link.l1.go = "saga_2";			
		break;
		
		case "saga_2":
			dialog.text = "Не торопитесь. Нечасто встретишь подобное благородство... Но деньги в этой печальной истории не самое главное. Одним из условий передачи Мишелю столь крупной суммы было решение им одной весьма деликатной задачи\nМишель де Монпе, как благоверный католик, поклялся на Библии, что найдет способ наказать одного зарвавшегося еретика и восстановить попранную им справедливость во славу Ордена и Святой Церкви...";
			link.l1 = "Но сидя под арестом на Мартинике он не сможет сдержать обещание!";
			link.l1.go = "saga_3";			
		break;
		
		case "saga_3":
			dialog.text = "Видите ли, мой друг, Мишель дал мне серьезный повод усомниться в его порядочности. Кто даст мне гарантии, что, выйдя на свободу, он не исчезнет, нарушив данное мне слово? Так что, если хотите окончательно снять с Мишеля все обвинения, исполните его клятву сами. Подробности, как и в прошлый раз, можете узнать у месье де Монпе. Если выполните и эту мою просьбу, то я в долгу не останусь, поверьте.";
			link.l1 = "Гм... Не ожидал. Но вы не оставляете мне выбора, шевалье. Что же, я приму решение после встречи с Мишелем.";
			link.l1.go = "saga_4";			
		break;
		
		case "saga_4":
			dialog.text = "Вы все больше нравитесь мне, "+pchar.name+". Возможно, однажды мы станем друзьями. Во всяком случае, это мое последнее условие освобождения Мишеля. В случае успешного разрешения проблемы даю слово, что вы сможете рассчитывать на мое дальнейшее расположение.";
		...
		case "serve":
			dialog.text = "Не беспокойтесь, "+pchar.name+", я держу слово. Мишель получит свободу, и все обвинения с него будут сняты. Без прикрас могу добавить - это ваша, и только ваша заслуга.";
		...
		case "serve_1":
			dialog.text = "Погодите, друг мой. Надеюсь, я могу называть вас так? Я хочу выразить вам благодарность от себя лично... Я внимательно наблюдал за вами с самого вашего прибытия на архипелаг, и в курсе большинства ваших дел. Вы успели заработать себе весьма громкую славу на Карибах и, без преувеличения - приобрели известность и немалый вес в определенных кругах. Такие люди нужны Франции\nКапитан "+GetFullName(pchar)+"! Властью, данной мне Его Величеством, королем Франции, я имею честь предложить вам патент капитана королевского флота и взять под свое командование корабль военно-морских сил Франции, королевский фрегат ''Гриффондор''!\nЕго бывший капитан шевалье де Фонтене вашими стараниями будет осваиваеться в новой должности губернатора Тортуги, а место капитана лучшего фрегата на Карибах не должно пустовать. Вы согласны?";
		...
		case "serve_2":
			...
			link.l1 = "От таких предложений не отказываются, ваша светлость! Почту за честь служить Франции!";
			link.l1.go = "serve_3";
			link.l2 = "Боюсь показаться нескромным, но я вынужден пока отклонить ваше щедрое предложение.";
			link.l2.go = "serve_no";
		break;
		
		case "serve_no":
			ChangeCharacterComplexReputation(pchar, "fame", 7);
			dialog.text = "Очень жаль. Я так надеялся... И, тем не менее, я вынужден просить вас еще об одном одолжении, тем более, что это и в ваших интересах. На Мартинику высажен испанский десант. В порту и в городе идут жаркие бои\nК сожалению, мне некого послать на помощь осажденному гарнизону, кроме вас. Прошу вас, сделать все, чтобы отразить атаку. Надеюсь, у вас для этого найдется достаточно сил и средств\nТем более, что этим вы можете спасти жизнь Мишелю, который до сих пор пребывает на базе Ордена.";
			link.l1 = "Мишель в опасности? Я немедленно отправляюсь в путь!";
			link.l1.go = "serve_exit";			
		break;
		
		case "serve_3":
			dialog.text = "Вот это достойные слова! Слова истинного солдата! Поздравляю вас, месье "+GetFullName(pchar)+". Вам присвоено звание коммандера военно-морского флота Франции. Позвольте вручить вам этот мундир. Носите его с гордостью и будьте достойны его!";
			link.l1 = "Служу Отечеству!";
			link.l1.go = "serve_4";			
		break;
		
		case "serve_4":
			dialog.text = "В ваше распоряжение поступает королевский фрегат ''Гриффондор''. Отныне этот великолепный корабль - ваш. Используйте его выдающиеся качества во славу Его Величества и для укрепления влияния Франции на Карибском архипелаге!";
		...
		case "patria_3":
			dialog.text = "Итак, "+pchar.name+", пока мы с бароном займемся инспекцией Капстервиля, я ставлю перед вами следующую задачу. Никто не может безнаказанно нападать на французские поселения, и испанцы, хотя уже и понесли от вас урок за агрессию на Мартинике, должны ответить за содеянное звонкой монетой и компенсировать нанесенный колонии ущерб\nВместе с бароном из Франции прибыла эскадра, в составе которой – мощный линейный 66-пушечный корабль 'Эклятон'. Капитан корабля – опытный моряк, но на Карибах он впервые, поэтому он поступает под ваше командование. Вместе с 'Эклятоном' вы отправитесь к берегам испанского острова Тринидад, и потребуете от испанцев денежной компенсации в триста тысяч песо за нападение на Форт де Франс.";
		...
		case "patria_6":
			dialog.text = "Тогда приступайте. Держите письмо для капитана 'Эклятона' с подтверждением ваших полномочий. Этот отличный корабль с великолепно обученной командой поступает под ваше командование. "+pchar.name+", и не забывайте, что вы теперь на службе Франции, и для общения с официальными лицами, включая меня, в первую очередь, необходимо быть в мундире. К тому же, он вам очень к лицу. Удачи, капитан "+pchar.name+"!";
			link.l1 = "";
			link.l1.go = "patria_7";
		break;
		...
		case "patria_8":
			...
			{
				dialog.text = "Замечательно, "+pchar.name+", но где же деньги?";
		...
		case "patria_8_4":
			dialog.text = "Итак, "+pchar.name+", вы принесли полученный выкуп с Тринидада?";
			if (sti(pchar.money) >= 300000)
			{
		...
		case "patria_9":
			...
			dialog.text = "Я вами доволен, "+pchar.name+", впрочем, как и всегда. Задание было непростым, и вам из суммы выкупа причитается премия - 50 000 песо. Возьмите, это ваше.";
		...
		case "patria_10":
			...
			dialog.text = "И для вас уже имеется новое поручение. Месье Форже закончил инспекцию в Капстервиле и теперь желает посетить наши северные колонии. Я прошу вас отвезти барона на Тортугу и Эспаньолу, всячески содействовать в его делах и выполнять его просьбы. Мы договорились, "+pchar.name+"?";
		...
		case "patria_13_1":
			dialog.text = "И еще, "+pchar.name+": вы снова без вашего офицерского мундира! Делаю вам замечание. И впредь прошу являться ко мне только в форме, в противном случае я просто не буду вас выслушивать. Вы на службе, и дисциплина должна быть во всем, в первую очередь - во внешнем виде морского офицера!";
		...
		case "patria_22":
			...
			link.l1 = "Хорошо, время у меня есть. Ведь надо еще посетить южные колонии, Гваделупу и Мартинику. Жаль, что камандор не будет сопровождать меня на этот раз - ему снова отправляться к берегам Эспаньолы...";
		...
		case "patria_25_1":
			dialog.text = "Да, еще, "+pchar.name+": я слышал, у вас проблемы с голландскими властями? Пожалуйста, уладьте этот вопрос как можно скорее, в недалеком будущем вам предстоит посещение голландских колоний. Как вы понимаете, под огнем фортов это будет невозможно.";
			link.l1 = "Хорошо, месье, я понял. Все будет сделано.";
			link.l1.go = "patria_25";
		break;
		
		case "patria_25_2":
			dialog.text = "Да, еще, "+pchar.name+": я заранее вас предупреждаю на всякий случай - избегайте конфликтов с голландцами. В скором будущем вам предстоит посещение голландских колоний. Как вы понимаете, под огнем фортов это будет невозможно.";
		...
		case "patria_29":
			dialog.text = "Ступайте, "+pchar.name+". С возвращением не затягивайте, барон не любит долго ждать. И обязательно на прием к Питеру Стайвесанту явитесь при параде, в форменном мундире! Все должно выглядеть официально, вы понимаете меня?";
		...
		case "patria_33":
			dialog.text = "И теперь по вашему очередному заданию: со дня на день в Капстервиль вернется барон Форже. Вы отвезете его на Синт-Маартен и обеспечите ему охрану. Ну и, так сказать, присмотритесь к тому, что будет происходить в Филипсбурге, а затем доложите мне. Не покидайте город, капитан, как только барон прибудет сюда - мой вестовой разыщет вас и доложит.";
		...
		case "patria_37":
			dialog.text = "";
			link.l1 = "Да, шевалье, уже вернулись! Ваши голландские друзья у Синт-Маартена встретили нас огнем из пушек форта и атаковали эскадрой из трех кораблей. Только благодаря мастерству капитана и его команды нам удалось уйти! Похоже, минхер Питер Стайвесант не очень желает видеть представителя короля Франции в Филипсбурге, шевалье?";
		...
		case "patria_39":
			dialog.text = "Барон, я прошу вас... Я во всем разберусь. Мы немедленно отправим нашего дорогого капитана снова на Кюрасао к Стайвесанту. У капитана большой опыт ведения деликатных дел... А сейчас я попрошу слуг приготовить для вас ванну и плотный обед.";
			link.l1 = "...";
		...
		case "patria_41":
			dialog.text = ""+pchar.name+", мой друг, вам нужно поспешить в Виллемстад. Возможно, Стайвесант еще там. Если же нет - выясните, где он, и отыщите. При встрече расскажите об инциденте и затребуйте объяснений. Я полагаюсь на ваш опыт и ваш авторитет и поручаю провести все переговоры вам. Затем, не медля ни минуты, возвращайтесь и доложите мне о результатах встречи.";
		...
		case "patria_51":
			dialog.text = "Я бы назвал это не войной, а принуждением к миру. И если Стайвесант одумается, мы будем только рады. Поэтому сейчас нам надо показать ему, что пытаясь присвоить остров Синт-Маартен, он теряет гораздо больше, чем приобретает. На это и будет ориентировано ваше задание, "+pchar.name+".";
		...
		case "patria_57":
			...
			dialog.text = "А теперь отдохните немного, "+pchar.name+". Вы заслужили это. А я пока озабочусь переговорами со Стайвесантом - возможно, он уже осознал, что враждовать с нами ему гораздо убыточнее, нежели дружить. Не покидайте город, дня через два вы мне будете нужны.";
		...
		case "patria_59":
			dialog.text = "Да. Похоже, Стайвесант начал против нас ответные действия в альянсе с Испанией. Совместная испано-голландская эскадра берет в кольцо Капстервиль. Дозорные форта докладывают мне каждый час об их перемещениях.";
			link.l1 = "Осада?";
		...
		case "patria_62":
			dialog.text = "Надеюсь, что да. Письмо должно убедить его в том, что награда за помощь будет весьма существенной... Кроме того, "+pchar.name+", нам нужно отправить весть капитану 'Эклятона', который сейчас находится у берегов Гваделупы, чтобы он поспешил к Сент-Кристоферу. Огневая мощь 'Эклятона' существенно поможет в предстоящем бою. Поскольку вы не можете разорваться на две части, к вам в эскадру войдет наш военный курьерский люггер - вы должны вывести его в целости за кольцо врагов, и он отправится к Гваделупе, пока 'Эклятон' не ушел на юг...";
		...
		case "patria_73":
			dialog.text = "Погодите, "+pchar.name+". Вы еще не получили свою награду за спасение Капстервиля. Примите от жителей города эти сундуки с золотом, а также огромную благодарность, которую нельзя оценить ни в каких деньгах!";
		...
		case "patria_81":
			dialog.text = "Превосходно! Для вас не существует слова 'невозможно', "+pchar.name+". Когда-то я думал, что Мишель де Монпе - лучший военный офицер на Карибах, однако ему до вас очень далеко, уж простите меня за такое бесцеремонное сравнение. Я думаю, вы уже догадались, кого я отправляю к нашему дорогому полковнику для участия в штурме Виллемстада.";
		...
		case "patria_83":
			dialog.text = "Задержитесь на минутку, "+pchar.name+". Наш друг, барон Форже, привез для вас новости с Синт-Маартена.";
			link.l1 = "...";
		...
		case "patria_87":
			DialogExit();
			AddQuestRecord("Patria", "65"); // далее коллизия Пуанси-Инспектор-"+pchar.name+"
		...
		case "patria_90":
			dialog.text = "Хотите жениться, "+pchar.name+"? А-ха-ха! Ткните пальцем в любую парижскую красотку - и она отдастся вам немедленно! Но, к сожалению, с этим придется немного повременить. Вы мне нужны здесь, мой друг, по крайней мере - еще немного.";
		...
		case "patria_97":
			dialog.text = "Ох, ну что вы, за кого вы меня принимаете! Барон - влиятельное лицо в Париже, друг министра финансов! К тому же, физическое устранение ничего не даст: из Парижа просто пришлют нового чиновника. Надо убить саму идею о возможности организации торговой компании тут, понимаете, "+pchar.name+"? Чтобы барон, вернувшись во Францию, доложил, что это финансово рискованно, неоправданно...";
			link.l1 = "У вас есть предложения, монсеньор?";
			link.l1.go = "patria_98";
		break;
		
		case "patria_98":
			dialog.text = "Увы, уже нет, "+pchar.name+". Я перепробовал все. Пугал недостатком кораблей и денежных средств, голландцами, пиратами... Все бестолку.";
			link.l1 = "Видимо, нужно что-то более серьезное, нежели просто слова. Гм... Пиратами, говорите?..";
			link.l1.go = "patria_99";
		break;
		
		case "patria_99":
			dialog.text = "Я вижу, у вас появилась идея, мой друг? Я не сомневался. У вас великолепный ум. Убедите нашего барона...";
			link.l1 = "Хорошо, шевалье. Задание мне ясно.";
			link.l1.go = "patria_100";
		break;
		
		case "patria_100":
			dialog.text = "Клянусь вам, "+pchar.name+", что в случае успеха вы не пожалеете. Можете быть уверены в этом. Я хоть раз обманул вас, мой друг?";
		...
		case "patria_104":
			dialog.text = "Мой друг, я в долгу перед вами. Я выплачиваю вам 100 000 песо - надеюсь, это покроет ваши издержки с пиратами...";
		...
		case "patria_105add":
			...
			dialog.text = "Также я приготовил для вас особенный подарок. Уверен, вы оцените значимость этой вещи и поймете глубину моей благодарности за вашу преданную службу! Итак, вице-адмирал "+ GetFullName(Pchar)+", я вручаю вам свой личный церемониальный меч мальтийского ордена! Это великолепное оружие как раз подойдет к вашему мундиру! Если вы решите вернуться в Европу, барон Ноэль Форже пообещал представить вас королю - вы должны быть на приеме при полном параде: в мундире и с этим наградным оружием! И вас ждет дальнейшая славная карьера в военно-морском флоте!";
		...
		case "patria_105":
			...
			PlaySound("interface\important_item.wav");
			dialog.text = "Заслужили!.. А пока вы остаетесь здесь, вас ждут небольшие перемены. Приятные, конечно. Вице-адмирал "+ GetFullName(Pchar)+", я назначаю вас губернатором Синт-Маартена!";
		...
		case "patria_109":
			dialog.text = "Когда решите - тогда и отплывете, а я, хоть и очень расстроюсь, отыщу вам замену.";
			link.l1 = "Хорошо, монсеньор, договорились. Теперь я могу идти? Новых дел пока не намечается?";
			link.l1.go = "patria_110";
		break;
		
		case "patria_110":
			dialog.text = "Пока нет, губернатор, но если появятся, я знаю, где вас искать. Удачи, "+pchar.name+"!";
		...
		case "patria_111":
			...
			pchar.questTemp.Patria.Governor = "true"; // "+pchar.name+" губернатор
			sld = CharacterFromID(pchar.questTemp.Patria.SpanishID);
			SetCharacterRemovable(sld, true);
		break;
		
		case "patria_112":
			dialog.text = "Черт возьми, какая беда! Боюсь, мы теперь не оберемся хлопот. Это вы приложили к этому руку, "+pchar.name+"? Скажите честно. Это не случайность?";
		...
		case "patria_x113":
			dialog.text = "Ясно. Ладно, друг мой, возможно, все не так и страшно. Лихорадка - есть лихорадка, ведь так? А до прибытия нового инспектора из министерства мы тут немного приберемся и будем встречать гостей во всеоружии... И нам нужно теперь, "+pchar.name+", свести к минимуму все наши контакты. Вы, надеюсь, понимаете, почему?";
			link.l1 = "Конечно.";
		...
		case "patria_113":
			dialog.text = "Ясно. Ладно, друг мой, возможно, все не так и страшно. Пираты - есть пираты, ведь так? А до прибытия нового инспектора из министерства мы тут немного приберемся и будем встречать гостей во всеоружии... И нам нужно теперь, "+pchar.name+", свести к минимуму все наши контакты. Вы, надеюсь, понимаете, почему?";
			link.l1 = "Конечно.";
			link.l1.go = "patria_114";
		break;
		
		case "patria_114":
			dialog.text = "В любом случае, мой друг, вы сделали все, что могли. И это лучше, чем совсем ничего. Я рад, что судьба свела меня с вами. Ваш чин остается при вас, и я уверен, вас ждет блестящая карьера во Франции. И я думаю, что вам уже пора отправиться в Европу.";
			link.l1 = "Хорошо, монсеньор, договорились. Никаких контактов, полная конспирация, и по возможности - в Париж. Теперь я могу идти?";
			link.l1.go = "patria_115";
		break;
		
		case "patria_115":
			dialog.text = "Ступайте, "+pchar.name+". Удачи вам!";
			link.l1 = "Взаимно, шевалье!";
		...
		case "patria_118":
			dialog.text = "Мой друг, я в долгу перед вами. Я выплачиваю вам 100 000 песо - надеюсь, это покроет ваши дорожные издержки, и еще немного останется вам на хороший отдых.";
			link.l1 = "Как приятно это слышать, монсеньор!";
			link.l1.go = "patria_105add";
		break;
		...
		case "patria_prison":
			dialog.text = "Как ты мог, "+pchar.name+"! Как ты мог так... поступить со мной!";
			link.l1 = "Кхм...";
			link.l1.go = "patria_prison_1";
		break;
		
		case "patria_prison_1":
			dialog.text = "Я знаю, что это ты. Не пытайся отрицать. Без твоего участия барон Форже никогда бы не смог получить ни показаний управляющего рудника Синт-Маартена, ни узнать, где находится рудник, ни, тем более, завладеть документами Питера Стайвесанта. Твое имя нигде не прозвучало, но я знаю: это был ты. Почему, "+pchar.name+"?.. Просто ответь: почему? Мишель? Миллион песо? Левассер? Или пост генерал-гебернатора?";

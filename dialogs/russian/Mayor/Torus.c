...
// ============================================================================
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			if (pchar.questTemp.mushkett2x2_torus == "go") 
			{
				pchar.questTemp.mushkett2x2_torus = "end";
				dialog.text = "Раз пришёл " + GetFullName(pchar) + ", то значит будут проблемы! Ха-ха-ха!";
...
//======================= пиратская линейка ===================================
	...
	LAi_group_MoveCharacter(sld, "PIRATE_CITIZENS");
		...
		case "Mushket_01":
			...
			link.l1 = "Слушай, Торус, говорит тебе что-нибудь слово ''стрела''? Может быть, одного из твоих парней так кличут, или судно пиратское так называется?";

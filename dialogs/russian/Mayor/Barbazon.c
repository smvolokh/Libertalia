...
//--> -----------------------------------Сага - Искушение Барбазона---------------------------------------------
		...
		case "junior_1":
			dialog.text = "Слушай внимательно. Ты должен встретиться с его доверенным лицом по кличке Валет. Он капитан пиратского корвета ''Пёс Войны'', больше я о нем ничего не знаю. Ты найдешь его в Капстервиле. Пароль - ''охота уже началась''. От него ты узнаешь, что делать дальше. Мне ты ничего не должен. Я просто решил тебе помочь. Если удача не отвернется от тебя, мы еще встретимся.";

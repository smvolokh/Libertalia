...
// ============================================================================
	switch(Dialog.CurrentNode)
	{
		...
		case "Mushkett":
			dialog.text = "О," + GetFullName(pchar) + ", какая встреча! Наслышан, наслышан о твоих делах... Зачем пожаловал к старине Бартоломью?";
			link.l1 = "Привет, Роджерс! Я к тебе по делу. Тебе говорит что-нибудь слово ''стрела''? Может быть, здесь бывает пират по кличке ''Стрела'', или судно пиратское с таким названием заходило к тебе в порт?";

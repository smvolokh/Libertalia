...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "ApostatesAPS_1":
			dialog.text = "Очень хорошо, капитан. Сегодня утром у меня пытались выведать информацию о Магистре. Я попросил этого человека зайти вечером, чтобы потянуть время.";
		...
		case "ApostatesAPS_2":
			...
			link.l1 = "Хорошо, кстати, мне Магистр сказал, что я могу получить 15000 песо.";

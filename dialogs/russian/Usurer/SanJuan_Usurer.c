...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			link.l1 = "Вы можете конкретно сказать место и время встречи? Попытаюсь незаметно подслушать их разговор.";
			link.l1.go = "ApostatesAPS2";
			break;
				
			case "ApostatesAPS2":
			dialog.text = "Известно, что они встречаются после полуночи в церкви. Смотрите, чтобы они вас не заметили, иначе вам не поздоровится, сеньор" + GetSexPhrase(".","ита.");
			link.l1 = "Постараюсь, спасибо тебе.";
			link.l1.go = "Exit";

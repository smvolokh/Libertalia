...
SetTimerCondition("NETRazborkiNaKorable", 0, 0, 0, false);
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		case "GothicApostates_dialog":
			...
			dialog.text = "Слушаю внимательнейшим образом, Ваше Преосвященство...";
			link.l1 = "...";
			link.l1.go = "GothicApostates_dialog1";
		break;
			
		case "GothicApostates_dialog1":
			dialog.text = "Сын мой, по нашим сведениям, это братство еретиков планирует обосноваться на Архипелаге! В этом им помогают нейтральные державы, особенно Голландская сторона\nУ них мощный флот, а также многие пиратские поселения оказывают им поддержку в стоянке и починке кораблей. Поэтому, чтобы окончательно уничтожить эту ересь, нам необходимы мощные корабли.";
			link.l1 = "...";
			link.l1.go = "GothicApostates_dialog2";
		break;
			
		case "GothicApostates_dialog2":
			dialog.text = "Разве флот Святой Церкви не справится? Один линейный корабль 'Инквизитор' чего стоит!";
			link.l1 = "...";
			link.l1.go = "GothicApostates_dialog3";
		break;
			
		case "GothicApostates_dialog3":
			dialog.text = "Это единственное хорошее судно, про остальные даже не хочу говорить, поэтому нам и нужны мощные суда испанского флота. Об этом я буду разговаривать с его превосходительством губернатором\nПо моим сведениям, еретика, который возглавляет это движение, зовут Рэндольф Кэннелл, и последний раз его видели в городе Порто Белло. Твоя задача - без промедления отправиться туда и выяснить максимум информации о нем.";
			link.l1 = "...";

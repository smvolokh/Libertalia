...
void ProcessDialogEvent()
{
	...
	// --------------------------------------вернулся на Остров---------------------------------------------
		...
		case "adversary_2":
			...
			link.l1 = "А-а! Это Элиза Мак Артур. Она, как и Даниэль, оказалась замешана в этой путаной истории, и сейчас служит у меня офицером. Временно, конечно.";
		...
		case "adversary_4":
			...
			link.l1 = "Мэри! Перестань плакать! Да что же с тобой за наказание такое - в схватке любому бретёру фору дашь, а глаза на мокром месте... Мэри, милая, Элиза - просто мой офицер, и всё.";
		...
		// соглашаемся
		case "adversary_hire":
			// проход второй - смотрим, Элиза может стать подругой или нет
		...
		case "adversary_hire_no": // Мэри не пойдет, пока не ГГ не расстанется с Элизой. Выбирай, кто тебе милее...
			...
			link.l1 = "Мэри, дорогая, я же сказал тебе, что Элиза - просто мой офицер! Между нами ничего нет! Хочешь, поклянусь в этом, чёрт возьми! Она мне нужна, чтобы распутать этот чёртов клубок интриг внутри Берегового Братства. Если я не помогу ей - Ян Свенсон не поможет мне взять Тортугу, а мне это очень надо!";
		...
		case "adversary_hire_no_4":
			...
			link.l1 = "Хорошо, Мэри. Давай договоримся так. Элизу я сейчас никуда выгнать не могу - она важная фигура в игре, которую мы затеяли со Свенсоном. Я решаю проблемы Элизы, она становится владелицей Исла Тесоро и отправляется на берег, и больше нас не связывают никакие отношения. Это займёт ещё месяц или два. Ты будешь ждать всё это время?";
		...
		// повторный разговор после расставания с Элизой
		...
		case "adversary_hire_yes": // Элиза заведомо не друг - Мэри идет сразу, либо если выбрал Мэри
	...
	// --> консультации по морским сражениям
		...
		case "fugas":
			...
			link.l1 = "В бухте Саба-Матила стоит корабль Джекмана, линейный фрегат 'Центурион'. Это судно принадлежало раньше Хоукам, кроме того, в каюте Джекмана должны быть важные документы и вещи... в общем, его нужно брать на абордаж.";
			link.l1.go = "fugas_1";
		break;
		
		case "fugas_1":
			dialog.text = "Понятно. И ты сейчас думаешь, как ухитриться сделать это на нашем корвете? У них команды больше, чем у нас, и пушек тоже. Я смотрела в подзорную трубу, да!";
	...
	// --> Мэри вне LSC
		...
		case "GoldenGirl_1":
			dialog.text = "Вот так, да?! Куртизанки, и ты так спокойно мне об этом говоришь, словно вы на абордаж какой прогуляться договорились со светлостью этой? "+pchar.name+", ты вообще ничего не забыл? ";
		...
		case "GoldenGirl_3":
			dialog.text = "Передышка нам точно не помешает, да. Но как ты думаешь, дама в английском мундире это высшее общество сильно шокирует? Представляешь эти шепотки по углам? Может, кто даже в обморок упадет, вот будет веселье, да?";
		...
		case "GoldenGirl_4":
			dialog.text = "Ой, не трудись, да. Скажи прямо - я не того полета птичка, чтобы красоваться перед всякими кружевными уродами. Так, девчушка для развлечений, но на людях с такой показаться стыдно, да? Не гожусь для красивых приемов, правда ведь, гроза морей и океанов "+GetFullName(pchar)+"?";
		...
		case "GoldenGirl_13":
			dialog.text = "Ты пропал на сутки у куртизанок, по городу ползут слухи один другого краше. "+pchar.name+", назови мне хоть одну причину вообще сейчас с тобой разговаривать, вместо того, чтобы всадить тебе пулю в... живот например? Ты меня совсем ни в грош ни ставишь да?";
		...
		case "GoldenGirl_15":
			dialog.text = "А я, тем временем, буду отсиживаться на выигранном тобой корыте? Ты совсем рехнулся, "+pchar.name+", да?";
		...
		case "GoldenGirl_24":
			dialog.text = ""+pchar.name+", ты все же спас меня, да! Я чуть не перестала надеяться! Я так рада тебя видеть!";
		...
		case "GoldenGirl_25":
			...
			{
				dialog.text = "А что ты вообще сделал, что меня отпустили вот так запросто? Без драки, без пальбы, да. И я видела красивую даму на палубе, когда меня выводили. Что там вообще произошло, "+pchar.name+"?";
			}
			else
			{
				dialog.text = "А что ты вообще сделал, что меня отпустили вот так запросто? Без драки, без пальбы, да! И я видела каких то расфуфыренных англичан на палубе, когда меня выводили. Что там вообще произошло, "+pchar.name+"?";
			}
		...
		case "GoldenGirl_26":
			dialog.text = "Уже смогла, "+pchar.name+". И ты прости меня, да! Если бы я так не расстроилась из-за той мадамы и, хотя бы, расставила вахту на фрегате... Они бы нас так легко не взяли, да! Глупо все вышло!";
		...
		case "GoldenGirl_27":
			dialog.text = "Я знала что ты меня не бросишь, да. Прости, что сомневалась в тебе, "+pchar.name+"! Полагаю, мне лучше не знать что именно ты сделал, так?";
		...
		case "GoldenGirl_28_1":
			...
			else
			{
				...
				link.l1 = "Вот уж не знаю. Как бы через пару месяцев не узнать, что началась война с Англией. Впрочем - я сделал то что должен был, Мэри. Ты для меня важнее всего на этом свете!";
			}
		...
		case "GoldenGirl_29":
			if (pchar.questTemp.GoldenGirl == "alarm_fin")
			{
				dialog.text = "Это неважно - ведь ты мое чудовище, "+pchar.name+"! А все остальные могут пойти и поплакать по этому поводу, или будут иметь дело со мной! Помни - я всегда на твоей стороне, да!";
			}
			else
			{
				dialog.text = "Я знаю, "+pchar.name+". Я всегда это знала, но я рада, что ты так говоришь. И ты знай - я всегда буду на твоей стороне, всегда, да!";
			}
		...
		case "GoldenGirl_32":
			dialog.text = ""+pchar.name+", это правда ты?! Я уже отчаялась, да! Господи, как я скучала! Прости меня, прости, да!";
		...
		case "GoldenGirl_34":
			dialog.text = "Ну да, это многое объясняет, но... Черт, я тоже, "+pchar.name+"! Я тоже тебя люблю, да! Наконец, мы снова вместе!";
		...
		case "GoldenGirl_37":
			dialog.text = "А твоя маркиза? Ты ее тоже вернул? Португалец о ней очень хорошего мнения. И заверил меня, что ты выдержал все ее осады не хуже Бастилии. Я хочу ему верить, да, но ты должен мне это прямо сказать, "+pchar.name+"!";
		...
		case "LongHappy":
			...
			dialog.text = "Морской берег, ты, я, и хорошее вино - "+pchar.name+", это так романтично! Нам стоило бы почаще вот так выбираться вдвоем, да!";
		...
		case "LongHappy_1":
			...
			link.l1 = "Потому что я люблю тебя, Мэри. Ты знаешь это, я знаю это, все знают это. Но здесь и сейчас, перед этим морем и небом, я прошу тебя, Мэри Каспер - окажи мне честь быть со мной перед людьми и Богом столько дней, сколько нам отведено свыше. Я - "+GetFullName(pchar)+" спрашиваю тебя - ты станешь моей женой?";
		...
		case "LongHappy_2":
			...
			{
				dialog.text = "Как я мечтала это услышать, да! Я... ты же знаешь мой ответ "+pchar.name+"... ой, прости!";
				link.l1 = "Ничего, это всего лишь вино, и я никогда не любил эту рубаху...";
				link.l1.go = "LongHappy_3";
			}
			else
			{
				dialog.text = ""+pchar.name+", конечно да! Да-да, тысячу раз да!! Ты... это место... ничто не может сделать меня более счастливой!! О Боже, я так счастлива, да!";
		...
		case "LongHappy_7":
			dialog.text = ""+pchar.name+", аббат Бенуа снова на Мартинике, значит мы можем приступать, да? Но я не полезу в платье, даже ради церковной службы ты не обидишься?";
		...
		case "LongHappy_9a":
			dialog.text = "- С тобой, мне хватит и корабельного капеллана на шканцах, под закатным солнцем у какого-нибудь побережья, да. Но - раз такое дело - будем праздновать! "+pchar.name+"... я сейчас расплачусь, обними меня, да...";
			link.l1 = "Мэри...";
			link.l1.go = "LongHappy_9b";
		break;
		
		case "LongHappy_9b":
			dialog.text = "Все, я спокойна, да. Прости - это все так необычно. Но "+pchar.name+", как хорошая жена, давай я возьму часть организации на себя. Ребятам тоже надо устроить праздник, да, а вряд ли вся команда поместится в церковь. Я договорюсь с таверной, но нам потребуется выпивка и деньги - ты же знаешь, как кутят моряки.";
		...
		case "LongHappy_13":
			dialog.text = "Все готово, "+pchar.name+", да? Я распоряжусь чтобы сгружали выпивку, схожу договорюсь с местной таверной, проведаю барона и передам письма. Ты подождешь здесь, да?";
		...
		case "LongHappy_15":
			dialog.text = "Здесь мы закончили, "+pchar.name+", да! Я все устроила, поверь мне - это будет замечательно! Одно смущает: таверна здешняя, сгорела во время какой-то пирушки с неделю назад. Но ее почти отстроили заново, больше и лучше, чем прежняя, да! Должны все поместиться.";
		...
		case "LongHappy_18":
			dialog.text = "Хорошо, я пока прогуляюсь по городу, проветрю голову, да! "+pchar.name+" - ты ведь понимаешь, что дороги назад не будет?";
		...
		case "LongHappy_26":
			dialog.text = "";
			link.l1 = "Я - "+GetFullName(pchar)+" беру тебя, Мэри Каспер, в законные жены, и клянусь хранить верность в счастье и в несчастии, в болезни и в здравии, а также любить и уважать тебя все отпущенные мне дни.";
			link.l1.go = "LongHappy_27";
		break;
		
		case "LongHappy_27":
			dialog.text = "Я, Мэри Каспер, беру тебя, "+GetFullName(pchar)+" в законные мужья и обещаю хранить верность в горе и в радости, в болезни и в здравии, а так же любить тебя и уважать все дни моей жизни, да!";
			link.l1 = "";
		...
		case "LongHappy_31":
			dialog.text = "Это невероятно, да! Я... я плачу, прости, "+pchar.name+", я сейчас... нос покраснел, да?";
			link.l1 = "Мэри, жена моя, ты прекрасна в этот день и в любой другой!";
			link.l1.go = "LongHappy_32";
		break;
		
		case "LongHappy_32":
			if (CheckAttribute(pchar, "questTemp.LongHappy.MarrySP")) dialog.text = "Спасибо, "+pchar.name+", спасибо... Это все так торжественно и прекрасно! Это самый лучший день в моей жизни, да!! Смотри, какие все кругом счастливые! Но - тебе же пора обойти гостей, и принять поздравления! Как закончишь - возвращайся - заглянем к ребятам в таверну.";
			else dialog.text = "Спасибо, "+pchar.name+", спасибо... Это все так торжественно и прекрасно! Это самый лучший день в моей жизни, да!! Смотри, какие все кругом счастливые! Но - тебе же пора обойти гостей, и принять поздравления! Как закончишь - возвращайся - в Шарптауне нас уже заждались.";
		...
		case "LongHappy_34":
			dialog.text = ""+pchar.name+", любимый, ты уже поговорил с гостями?";
		...
		case "LongHappy_35":
			...
			{
				dialog.text = "Да, да! Мне тоже столько всякого приятного наговорили! Не все, конечно - кое-кто явно удивлен моим нарядом, да! Но я так счастлива, что половину не успеваю даже услышать. И в целом все такие милые. "+pchar.name+"! Нас же заждались в Шарптауне, когда отплываем?";
		...
		case "LongHappy_39":
			dialog.text = "Оторви ты ему немытую башку, "+pchar.name+", да!";
			link.l1 = "";
		...
		case "LongHappy_44":
			dialog.text = "Мы победили, да! Прости, что не успела, "+pchar.name+" - там еще дюжина этих крабьих пащенков под шканцами пряталась - пришлось повозиться!";
		...
		case "LongHappy_49":
			...
			{
				dialog.text = "Мне так жаль, "+pchar.name+", да, я... я ходила прогуляться. Видела, что вы вернулись, слышала что с победой и все живы, но я... Да что ж это такое, да!";
			...
			else
			{
				...
				{
					dialog.text = "Мне очень жаль Джино, "+pchar.name+", да! Я как узнала, не поверила! Ты как?";
		...
		case "LongHappy_53":
			dialog.text = ""+pchar.name+", я вижу, что ты на ногах не стоишь, но Тичингиту так и не нашелся - я весь город обошла - ни следа!";
		...
		case "LongHappy_55":
			dialog.text = "Ну дает наш суровый абориген, да! Пойдем, Данни нашла нам домик тут на окраине - ты же уже спишь на ходу, "+pchar.name+", да!";
		...
		case "LongHappy_57":
			dialog.text = "Не пойми меня неправильно, муж мой, в церкви все было просто роскошно, но здесь атмосфера явно душевнее, да! Ну что ж, вот и все, "+pchar.name+"  - теперь все хлопоты позади, можно и расслабиться.";
		...
		case "LongHappy_61":
			dialog.text = "Я так счастлива, "+pchar.name+"!.. А теперь, нам ведь пора снова в путь, да?";

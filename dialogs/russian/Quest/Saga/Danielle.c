...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "meeting_5":
			dialog.text = "Спрашиваешь! Конечно, готова. После того, как мне пришлось убраться из Саванны-ла-Мар, я только и делаю, что путешествую. К тому же, я не пассажиром к тебе просилась.";
		...
		case "arrive_11":
			...
			link.l1 = "Ну конечно! Там я нашел, кроме Натана, еще и Акулу Додсона. У меня теперь есть точные координаты Острова и лоция, чтобы пройти через рифы, которыми он окружен. Сейчас мы возвращаемся назад, к кораблю, идем в Блуфилдс...";
		...
		case "nathaniel_13":
			...
			link.l1 = "Никто и никогда не узнает о том, что здесь происходило. Обещаю. Также никто не узнает, что было с Натаном. Пираты Саванны-ла-Мар увидят его прежним, сильным и грозным Натаниэлем Хоуком!";
		...
		case "treatment_2":
			dialog.text = "Я тоже ему верю. Я останусь в твоей команде еще на некоторое время, "+pchar.name+", ты не возражаешь? Нам нужно найти главного мерзавца и виновника наших бед - скотину Джекмана. Это он организовал засаду на Натана! Он захватил его место в Саванне-ла-Мар! Он украл ''Центурион'', наш фрегат!";
		...
		case "islatesoro_2":
			...
			link.l1 = "Мы с Яном считаем, что Блейза Шарпа на Исла Тесоро убрал Джекман, свалив вину на Акулу. А завещание... девка... это он Элизу имеет в виду... Черт возьми, да как же я раньше не догадался! Этот подонок наверняка ошивается где-то у Исла Тесоро!";
			link.l1.go = "islatesoro_3";
		break;
		
		case "islatesoro_3":
			dialog.text = "Тогда не будем терять времени, "+pchar.name+"?";
			link.l1 = "Да. Отправляемся к Исла Тесоро. Старина ''Пёс Войны'' послужит нам для этого рейда как нельзя лучше.";
		...
		case "after_boarding_2":
			dialog.text = "Что? Отведу корабль в Шарптаун, отремонтирую, найму хотя бы минимум команды и пойду в Блуфилдс. Попрошу Яна Свенсона, чтобы его люди присмотрели за ''Центурионом'', а сама отправлюсь к мискито - буду ждать, пока Змеиный Глаз вылечит моего мужа.";
		...
		case "after_boarding_3":
			...
			link.l1 = "Разумные слова, Данни! Когда Натаниэль выздоровеет, он снова должен занять свое положенное место в Саванне-ла-Мар.";
			link.l1.go = "after_boarding_4";
		break;
		
		case "after_boarding_4":
			dialog.text = "Так-то оно так... Но пиратский барон -  выборная должность. Вдруг сходка Саванны-ла-Мар проголосует иначе?";
		...
		case "after_boarding_6":
			dialog.text = "Я хочу, чтобы ты знал - в Саванне-ла-Мар тебе всегда будут рады. Когда будет возможность - обязательно загляни к нам. Мы с Натаниэлем придумаем, как тебя отблагодарить.";
		...
		case "after_boarding_8":
			...
			link.l1 = "Чудесно. А вообще, мне даже как-то жаль с тобой расставаться, Данни... Увидимся в Саванне-ла-Мар!";
		...
		// в Саванне-ла-Мар
		case "marun_town":
			dialog.text = ""+pchar.name+", очень рада тебя видеть! Мы снова в Саванне-ла-Мар, и Натан занял свое законное место. Кстати, все в поселке были этому очень рады. Теперь опять все будет по-прежнему! Огромное тебе спасибо за твою бескорыстную помощь!\nЯ хочу сделать тебе подарок. Вот, возьми. Этот талисман очень поможет тебе в бою. А следуя этому рецепту ты всегда сможешь создать его самостоятельно.";
		...
		case "marun_town_2":
			...
			PlaySound("interface\important_item.wav");
			dialog.text = "Вот и славно! "+pchar.name+", я хочу, чтобы ты знал: ты - наш лучший друг. Мы с Натаном всегда будем рады видеть тебя в Саванне-ла-Мар! Заходи почаще!";

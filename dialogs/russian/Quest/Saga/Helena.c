// Элиза Мак Артур - сомнительная любовь и офицер
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "After_boarding_3":
			...
			link.l1 = "Нет проблем, Элиза. Я прикажу подать тебе еду и приготовить койку. Будь моей гостьей!";
		...
		case "Return_blueveld_1":
			...
			LocatorReloadEnterDisable("SantaCatalina_houseSp3", "reload2", true);//закрыть спальню Элизы
		...
		case "Helena_hire":
			...
			link.l1 = "Свенсон сказал, что ты рвёшься ко мне в офицеры. Я очень рад твоему желанию - Глэдис говорила, что ты очень тоскуешь без моря. Добро пожаловать в мою команду, офицер Элиза Мак Артур!";
			link.l1.go = "Helena_hire_1";
			if (CheckAttribute(pchar, "questTemp.Saga.Helena_friend"))
			{
				link.l2 = "Свенсон сказал, что ты хочешь стать офицером на моём корабле. Я очень рад твоему желанию - Глэдис говорила, что ты очень тоскуешь без моря. Добро пожаловать в мою команду, офицер Элиза Шарп!";
		...
		case "Helena_hire_5":
			...
			link.l1 = "Судьба, говоришь... Что жe, вполне может быть и так. Я постараюсь не разочаровать тебя, а могилку твоей матери мы поищем вместе. А пока... Офицер Элиза Шарп! Собирайся и не опаздывай к отплытию!";
			link.l1.go = "Helena_hire_6";
		break;
		...
		case "fugas_1":
			dialog.text = "Понятно. И ты сейчас думаешь, как ухитриться сделать это на нашем корвете? У них команды больше, чем у нас, и пушек тоже.";
		...
		case "fugas_2":
			...
			link.l1 = "Элиза! Я же только что сказал - фрегат нельзя топить, его нужно абордировать!";
			link.l1.go = "fugas_3";
		break;
		...
		case "fugas_5":
			...
			link.l1 = "Ну что же, попробуем. Главное - чтобы они не увидели раньше времени, что ''Пёс Войны'' уже не под командованием братца Джекмана... Чёрт возьми, это будет нелегко - к ним подобраться. Джекман не такой простак, как Упырь.";
			link.l1.go = "fugas_6";
		break;
	...
	// --> разговор по итогам Саги
		case "result":
			...
			else
			{
				...
				link.l1 = "Хм. Ты уверена, Элиза? Подумай, у тебя же в собственности целый остров!";
				link.l1.go = "result_9";
			}
		break;
		...
		case "result_4":
			...
			link.l1 = "Опомнись, Элиза! Он же бандит и пират!";
			link.l1.go = "result_5";
		break;
		...
		case "result_6":
			...
			link.l1 = "Я услышал тебя. Но более никогда не смей угрожать мне, Элиза... Белтроп. За время службы на моём корабле ты должна была понять, что я не боюсь ни чёрта, ни морского дьявола. И тебя тоже не испугаюсь, поверь мне. А теперь - прощай. И не смотря ни на что, я желаю тебе удачи.";
			link.l1.go = "result_8";
		break;
		
		case "result_7":
			dialog.text = "Спасибо. Возможно, ещё когда-нибудь встретимся, "+pchar.name+"...";
			link.l1 = "А почему нет? На Исла Тесоро мне предстоит побывать ещё не раз. Там и увидимся... Пока, Лиззи!";
			link.l1.go = "result_8";
		break;
		
		case "result_8": // Элиза уходит, но ее не затираем
			DialogExit();
		...
		case "result_9": // вот тут - ключевой момент, если игрок нашел Мэри - выбирай, какая девушка милее
			...
			{
				link.l1 = "(выбрать Мэри) Элиза! Ты, похоже, не понимаешь. Ты обеспечена до конца своих дней, и можешь не беспокоиться о будущем. У меня же впереди - война, закулисные интриги и полная неизвестность. Тебе нужно устраивать свою жизнь, а не связывать её с авантюристом.";
				link.l1.go = "result_10";
				link.l2 = "(выбрать Элизу) Я мог только мечтать об этом, Лиззи. Конечно, я не хочу терять тебя, но, возможно, тебе было бы лучше отправиться на Исла Тесоро. Кто знает, куда приведёт меня моя судьба. У меня впереди - война, закулисные интриги и полная неизвестность.";
				link.l2.go = "result_15";
			}
			else
			{
				link.l1 = "Я мог только мечтать об этом, Лиззи. Конечно, я не хочу терять тебя, но, возможно, тебе было бы лучше отправиться на Исла Тесоро. Кто знает, куда приведёт меня моя судьба. У меня впереди - война, закулисные интриги и полная неизвестность.";
		...
		case "result_10":
			...
			link.l1 = "Элиза! Я в первую очередь думаю о тебе! Как ты этого не понимаешь?!";
		...
		case "result_11":
			...
			link.l1 = "Конечно... Элиза, мы с тобой ещё не раз встретимся на Исла Тесоро. Тебя отвезти на твой остров?";
		...
		case "result_12":
			...
			link.l1 = "Очень рад, Элиза, что ты оказалась такой... хозяйственной. Но владелице Исла Тесоро не пристало ходить на шхуне - думаю, в скором времени ты обзаведёшься собственным фрегатом.";
		...
		case "happy_1":
			...
			pchar.questTemp.Saga.Helena_officer = "true"; // показатель, что Элиза - наша навсегда
		break;
		
	// -------------------------------------------- провалы саги ------------------------------------
		case "failcenturion":
			dialog.text = "Капитан! Джекман уничтожен... Это значит, что более ни с чьей стороны в адрес моей семьи угроз и опасностей нет?";
			link.l1 = "Да, Элиза, это так. Но радости у меня мало - вместе с 'Центурионом' утонули документы и вещи, которые могли бы позволить нам найти могилу твоей мамы, и доказать твои права на Исла Тесоро. Эх... Теперь и Тортугу придётся брать в одиночку...";
		...
		case "failcenturion_2":
			dialog.text = "Да, мой капитан. Мне удалось отложить на твоей службе денег, достаточных для покупки и снаряжения шхуны. У меня снова будет моя 'Радуга'. Но мы с тобой ещё не раз увидимся в Блуфилдс, правда? Я возвращаюсь домой.";
			link.l1 = "Ну что же... удачи, Элиза!";
		...
		case "late_l1":
			...
			link.l1 = "Удачи, Элиза. Мне жаль, что всё так неудачно вышло. Прощай.";
			link.l1.go = "failcenturion_3";
		break;
		
		case "late_l2":
			dialog.text = "Капитан! Джекман уничтожен... Это значит, что более ни с чьей стороны в адрес моей семьи угроз и опасностей нет?";
			link.l1 = "Да, Элиза, это так. Но радости у меня мало - я потерял очень много времени, и Исла Тесоро теперь - английская колония. И ты теперь без положенного наследства, и мне придётся брать Тортугу самому...";
			link.l1.go = "failcenturion_1";
		break;
	...
	// <-- провалы Саги
		...
		// секс - Элиза соглашается не всегда (голова болит, а что вы хотели? :)) и сама не требует секса
		case "cabin_sex":
			...
			else
			{
				...
				link.l1 = RandPhraseSimple("Ты моя умничка...","Ты - просто прелесть, Лиззи...");
		...
		case "sex_after":
			...
			link.l1 = RandPhraseSimple("Я рад, что ты осталась довольна...","Мне с тобой очень хорошо, Лиззи...");
			link.l1.go = "exit";
		...
		case "Helena_officer":
			...
			{
				Link.l4 = "Элиза, я собираюсь отправиться в старый индейский город Тайясаль. Не буду скрывать: это крайне опасное путешествие, и более того - необычное: через телепортационный истукан. Ты... пойдёшь со мной?";
				Link.l4.go = "tieyasal";
			}
			if (CheckAttribute(npchar, "quest.fugas"))
			{
				Link.l3 = "Элиза, я хочу с тобой посоветоваться.";
				Link.l3.go = "fugas";
			}
			Link.l1 = "Элиза, у меня для тебя есть распоряжение...";
			...
			{
				Link.l2 = RandPhraseSimple("Лиззи, может, останемся в каюте вдвоём... на ближайшие пару часов? Ты не против?","Дорогая, может, проведём следующие несколько часов тет-а-тет? Ты не против?");
			...
			{
				Link.l2 = RandPhraseSimple("Лиззи, может, снимем комнату и останемся там вдвоём... на ближайшие пару часов? Ты не против?","Дорогая, может, проведём следующие несколько часов тет-а-тет? Снимем комнату... Ты не против?");
				Link.l2.go = "room_sex";
			}
			link.l9 = "Пока ничего, Элиза.";
			link.l9.go = "exit";
			NextDiag.TempNode = "Helena_officer";
		break;
		...
		case "terrapin_grot_1":
			...
			link.l1 = "Ты умничка, Лиззи! И что бы я без тебя делал?.. Кэтрин, следуй за мной!";
		...
		case "on_coast":
			...
			link.l1 = "Лиззи... Милая, что произошло? Аргх, голова раскалывается...";
		...
		case "on_coast_1":
			...
			link.l1 = "Ты умничка, Лиззи... Что бы я без тебя делал?";
		...
		case "on_coast_5":
			...
			link.l1 = "Знаешь, Лиззи, я, пожалуй, тоже. Но сейчас мы пойдём назад в деревню карибов. Я должен всё рассказать Туттуатхапаку. Этот проклятый корабль напал на нас из-за амулета! Надеюсь, краснокожий дьявол сможет объяснить мне, зачем он понадобился мертвецам.";
			link.l1.go = "on_coast_6";
		break;
		
		case "on_coast_6":
			dialog.text = "Хорошо. Но тебе нужно беречь себя - твои раны до сих пор сочатся кровью.";
			link.l1 = "Но ты же поможешь мне исцелиться, моя девочка? И, Лиззи: я люблю тебя...";
		...
		case "islatesoro":
			...
			link.l1 = "Да всё как обычно - по делам. И, конечно, не забыл тебя проведать, Элиза...";
		...
		// Jason Дороже золота
		case "GoldenGirl":
			dialog.text = "Ну, капитан, что там припекло в этот раз нашему дражайшему губернатору? С кем деремся? Испанцы, пираты, или что похуже?";
			link.l1 = "Хуже, Лиззи, хуже. Губернатор намерен посетить крайне дорогую куртизанку, а я при нем в качестве диковинки, обещанной хозяйке. Скучная болтовня, дорогое вино и унылые аристократы.";
		...
		case "GoldenGirl_1":
			...
			link.l1 = "Послушай, это все прекрасно звучит, и я с радостью, но потом. Я обещал губернатору, для старика это важно, и вообще...";
			link.l1.go = "GoldenGirl_2";
		break;
		
		case "GoldenGirl_2":
			dialog.text = "Вообще что? Я знаю, что такое ''высшее общество'': для них "+GetFullName(pchar)+" не капитан, которому доверяют жизнь и за которым идут в огонь. Не равный вельможа - равные сидят в кресле в канцелярии, а не скачут по вантам в пороховом дыму. Даже не человек! Он просто... необычная приправа к ужину или беседе. Знаешь, как комнатный леопард, или заморский уродец с двумя головами! Занятная безделушка, пока не надоест! С каких пор ты готов быть безделушкой?!";
			link.l1 = "Лиззи, не беспокойся, я способен выдержать несколько любопытных взглядов, чтобы уважить губернатора. Это проще чем идти на абордаж под картечью. Уверен, я справлюсь. И эти самые 'бестолочи' не всегда такие. Даже в высшем обществе есть достойные люди... ну, или должны быть.";
			link.l1.go = "GoldenGirl_3";
		break;
		
		case "GoldenGirl_3":
			dialog.text = "Хорошо. Но учти - ради этих 'достойных' я в платье не полезу - хотят, пусть падают в обморок или возмущенно шепчутся под веерами, мне плевать.";
			link.l1 = "Я и не собирался тебя заставлять. Не вижу смысла страдать всем вместе. Я переживу этот прием, а потом махнем на Исла Тесоро. Я помню в трюме был ящик отличной испанской мадеры...";
			link.l1.go = "GoldenGirl_4";
		break;
		
		case "GoldenGirl_4":
			dialog.text = "То есть я для такой компании не подхожу, это ты хочешь сказать? Когда обезьянка приводит с собой еще одну, это уже перебор? Интересно. Хорошо, не забудьте одеться поприличнее, капитан. Когда на обезьянке воротник и манжеты, это приводит в умиление даже куртизанок. Удачного выступления!";
			link.l1 = "Лиззи, постой! Проклятье...";
			link.l1.go = "GoldenGirl_8";
		break;
		
		case "GoldenGirl_5":
			dialog.text = "Да, мы заслужили отдых, согласна. Но будь я проклята, если полезу в платье ради этого приема. Как думаешь, долго потом будут сплетничать о твоей спутнице, заявившейся в мужской рубахе и матросских штанах, в высших кругах Сен Пьера?";
			link.l1 = "Не думаю, что это хорошая идея. Эта маркиза из тех, на приемы к которым мужчины своих дам не берут. Уважаемых дам.";
		...
		case "GoldenGirl_6":
			...
			link.l1 = "Лиззи, я просто буду сопровождать губернатора, по его же настоятельной просьбе. Никаких... куртизанок. Ну то есть, они там будут, но... Проклятье! Да это просто визит вежливости!";
		...
		case "GoldenGirl_10":
			...
			link.l1 = "Лиззи, ну сколько можно?!";
		...
		case "GoldenGirl_13":
			dialog.text = "Ну, и как местным вельможам новая обезьянка? В городе болтают, что ее выступление произвело настоящий фурор! Играть в карты на корабли и куртизанок, а потом бросить вызов какому то вельможному мерзавцу? Может объяснишь, что это за чертовщина?";
			link.l1 = "Лиззи, все немного сложнее. Проклятье, прости меня, я не думал, что задержусь настолько, пришлось заночевать в доме мадам Бото. Одному, клянусь! И да, я выиграл в карты отменный фрегат. Представляешь?";
			link.l1.go = "GoldenGirl_14";
		break;
		
		case "GoldenGirl_14":
			dialog.text = "Отлично! Я начинаю думать, что ты либо святой, либо дурак. Но выигранных куртизанок и корабли обсудим позже - сейчас рассказывай что за дуэль и почему все говорят об этом так, словно ты дерешься по меньшей мере с наследным принцем?";
		...
		case "GoldenGirl_15":
			...
			link.l1 = "Вот поэтому его светлость дал мне секундантов из благородных офицеров гарнизона. Больше я никого с собой не возьму - если дойдет до разбирательств и суда, не должно быть никаких сомнений, что все было по кодексу и по закону. А тебя прошу, присмотри за фрегатом, пока меня не будет.";
			link.l1.go = "GoldenGirl_16";
		break;
		
		case "GoldenGirl_16":
			dialog.text = "Давай-ка уточним, правильно ли я поняла. Ты пропал почти на сутки, выиграл в карты баснословно дорогую... даму. Теперь идешь драться из-за нее с могущественным благородным выродком, которого даже нельзя убивать, а я... мы все, должны сидеть на заднице и ждать, чем все закончится? Интересно, что я должна думать по этому поводу? Как считаешь?";
			link.l1 = "Лиззи, послушай, ты имеешь право злиться, и мне очень жаль, но все не так просто...";
			link.l1.go = "GoldenGirl_17";
		break;
		
		case "GoldenGirl_17":
			dialog.text = "Знаешь что, хватит. Иди и делай то, что считаешь нужным. Мне здесь, судя по всему, места нет, но об этом мы поговорим, когда все закончится. А я, пока, пойду и попытаюсь это как следует запить. За твоим новым фрегатом я присмотрю, не беспокойся. И капитан, постарайся выжить... чтоб я сама могла тебя прибить.";
			link.l1 = "Лиззи, да позволь мне все объяснить, наконец! Проклятье... Опять?!";
			link.l1.go = "GoldenGirl_23";
		break;
		
		case "GoldenGirl_18":
			dialog.text = "Говорят, в городе теперь новая мода - корабли и куртизанок надо выигрывать в карты, а не покупать! Причем, бывших владельцев, чтобы быть до конца утонченным, следует вызывать на дуэль. Во что ты, черт возьми вляпался на этот раз?";
			link.l1 = "Лиззи, все немного сложнее. Проклятье, прости меня, я не думал что задержусь настолько. Этот вечер превратился в форменное сражение за карточными столами. И да, я выиграл в карты отменный фрегат. Представляешь?";
		...
		case "GoldenGirl_19":
			...
			link.l1 = "Мне пришлось. Долго объяснять, но я выиграл. А теперь - мой соперник, обвинил меня в мошенничестве и вызвал на дуэль. Он бастард  крайне могущественного вельможи, графа де Леви Вантадура, и мне придется изо всех сил постараться, чтобы не убить его на дуэли.";
			link.l1.go = "GoldenGirl_20";
		break;
		
		case "GoldenGirl_20":
			dialog.text = "А он тоже будет стараться не убить тебя? Ты совсем рехнулся, капитан? Рисковать всем кораблем, а теперь и своей жизнью из-за какой-то... мадам? Она действительно того стоит?";
			link.l1 = "Лиззи, для ревности нет повода, клянусь. Просто так сложилось. Я должен это сделать, и губернатор назначил мне секундантов из числа благородных офицеров, чтобы исключить любые сомнения после дуэли. Я не могу взять ни тебя ни кого-то из ребят. Прошу, присмотри за фрегатом, пока меня не будет.";
			link.l1.go = "GoldenGirl_21";
		break;
		
		case "GoldenGirl_21":
			dialog.text = "Просто чудесно! Ты отправляешься к куртизанкам - заметь, я тебе даже в спину не выстрелила - пропадаешь неизвестно куда почти на сутки. Возвращаешься с известием, что только чудом не проиграл корабль, зато выиграл эту самую куртизанку. И теперь из-за нее будешь драться с вельможным засранцем, которого даже убивать нельзя? Интересно, что я должна думать по этому поводу? Как считаешь?";
			link.l1 = "Лиззи, послушай, ты имеешь право злиться, но все не так просто...";
			link.l1.go = "GoldenGirl_22";
		break;
		
		case "GoldenGirl_22":
			dialog.text = "Знаешь что, хватит. Иди и делай то, что считаешь нужным. Мне здесь, судя по всему, места нет, но об этом мы поговорим, когда все закончится. А я, пока, пойду и попытаюсь это как следует запить. За твоим новым фрегатом я присмотрю, не беспокойся. Но если с тобой хоть что-то случится - клянусь Богом, я направлю пушки на город и сровняю с землей и этот бордель и особняк нашей разлюбезной светлости.";
			link.l1 = "Лиззи, все будет хорошо, поверь мне. Постой, ну куда ты?! Проклятье... Опять?!";
			link.l1.go = "GoldenGirl_23";
		break;
		...
		case "GoldenGirl_24":
			dialog.text = ""+pchar.name+", а теперь будь добр, объясни мне: что за чертовщина тут вообще творилась? На корабль среди ночи ворвались какие-то головорезы. Потом этот немытый хмырь, гнусно хихикая, спрашивал меня, на что ты пойдешь, чтобы меня вернуть. А затем меня заперли в кубрике, и я потеряла счет дням!";
		...
		case "GoldenGirl_25":
			...
			link.l1 = "Главное - ты теперь снова со мной. Я так виноват перед тобой, Лиззи, за всю эту историю! Не знаю, сможешь ли ты меня простить!";
			link.l1.go = "GoldenGirl_26";
		break;
		
		case "GoldenGirl_26":
			dialog.text = "Уже. И ты прости меня, "+pchar.name+". Если бы я не приняла все так близко к сердцу с этой дуэлью и маркизой, и хотя бы расставила вахту на фрегате... Глупо все вышло!";
			link.l1 = "Все вышло как вышло, и это уже в прошлом. Ты вернулась ко мне, и это все, о чем я смел мечтать последние недели. Я многое понял за это время, Лиззи. Очень многое. Я люблю тебя, и больше никогда не оставлю. Обещаю!";
		...
		case "GoldenGirl_28_1":
			...
			{
				dialog.text = "Ну и история вышла... Я верю, что у тебя не было иного выбора, но как мы объясним все Дил ду Парке и прочим? Ты же фактически поставил себя вне закона?";
				link.l1 = "Я согласился с этой ценой. И да - выбора действительно не было. Не беспокойся - я найду способ восстановить свое доброе имя. А нет - так на Исла Тессоро нам всегда рады! Если ты со мной - остальное неважно.";
			}
			else
			{
				dialog.text = "Ну и история вышла... Я верю, что у тебя не было иного выбора, но что теперь будет? Этот англичанин действительно все уладит, или будем воевать? Не хочешь отправится в Бас Тер и лично полюбоваться как на заносчивого мерзавца оденут цепи?";
				link.l1 = "Знаешь, Лиззи, пару недель назад я бы ни за что не упустил такой шанс. Но теперь - пусть бастард отправляется к черту! Мне даже плевать поймают его или нет - это все больше не моя проблема. Мы снова вместе - вот что по настоящему важно!";
			}
		...
		case "GoldenGirl_29":
			...
			{
				dialog.text = "Мне нравится такой подход, "+pchar.name+"! Французы, англичане, испанцы - пусть сами разбираются. Думаю - мы действительно заслужили немного покоя!";
		...
		case "GoldenGirl_30":
			...
			{
				dialog.text = "Звучит отлично! Пойду отдам ребятам команду сниматься с якоря! И, "+pchar.name+", ты же знаешь...";
				link.l1 = "Да, Лиззи, я знаю. Поднимайся на палубу, я сейчас буду.";
			}
		...
		case "GoldenGirl_32":
			dialog.text = ""+pchar.name+", ты жив! У тебя получилось!! Португалец мне все рассказал! Ну и история вышла!";
			link.l1 = "Слава Богу, ты жива, Лиззи. Ты не представляешь, как я рад тебя видеть!";
			link.l1.go = "GoldenGirl_33";
		break;
		
		case "GoldenGirl_33":
			dialog.text = "Кстати, об этом. Ты все мне обещал что-то рассказать? Что-то важное и сложное. Это твой шанс, капитан, я жду. Что, черт возьми, за безумие тут вообще произошло?!";
			link.l1 = "Я... я люблю тебя Лиззи. А все остальное - неважно.";
			link.l1.go = "GoldenGirl_34";
		break;
		
		case "GoldenGirl_34":
			dialog.text = "Ну да, это многое объясняет, но... Черт, я тоже, "+pchar.name+". Я тоже тебя люблю. Боже, как я скучала!";
			link.l1 = "И я скучал. Пойдем, сегодня я тебя не оставлю, даже если небо начнет рушиться на этот город, будь он неладен. Я тебя вообще больше не оставлю. Никогда.";
		...
		case "GoldenGirl_36_1":
			...
			link.l1 = "Нет, Лиззи, из-за моей глупости. Я должен был тебя вернуть и все исправить.";
			link.l1.go = "GoldenGirl_37";
		break;
		
		case "GoldenGirl_37":
			dialog.text = "Очень романтично, я даже готова забыть о том, с чего все началось... Ну, почти готова. Ладно, черт с ним! Так тебя подозревали, потому что Португалец сказал тебе неверное название этой клятой бригантины?";
		...
		case "GoldenGirl_38":
			dialog.text = "Отплыл. Почти сразу, как доставил меня сюда. Гостеприимством твоей выигранной куртизанки я не воспользовалась, и Бартоломью снял мне комнату тут, оплатив ее на пару недель, и исчез, даже не попрощавшись. Ой нет, погоди - он же оставил письмо!";
			link.l1 = "Письмо? Бартоломью Португалец? Это что-то новенькое. Меня терзают смутные сомнения...";
			link.l1.go = "GoldenGirl_39";
		break;
		
		case "GoldenGirl_39":
			dialog.text = "Ладно, ты читай, а я побегу - покажусь нашим, а то мы еще сутки тут просидим, а они же тоже волнуются. Не думала, что буду скучать по этим вечно хмурым рожам! А ты постарайся не влипнуть в очередное безобразие!";
			link.l1 = "Я бы и неделю так просидел... Проклятье, я все таки тебя вернул! Поверить не могу!";
		...
		case "LongHappy":
			...
			dialog.text = "Прибой и ветер, ты я, хорошее вино - стоило бы почаще вот так выбираться, а "+pchar.name+"?";
		...
		case "LongHappy_1":
			dialog.text = ""+pchar.name+", что ты задумал, и почему ты на коленях? Это же не...";
			link.l1 = "Лиззи, я люблю тебя. И я хочу прожить с тобой каждый день, отпущенный мне свыше. Потому, здесь и сейчас, перед этим морем и небом, я прошу тебя: Элиза Беатрисс Шарп, окажи мне честь быть со мной, перед людьми и Богом, пока смерть не разлучит нас. Я - "+GetFullName(pchar)+" спрашиваю тебя - ты станешь моей женой?";
		...
		case "LongHappy_2":
			...
			{
				dialog.text = "Конечно да! "+pchar.name+", Да, да, и еще раз да!";
				link.l1 = "Наша жизнь - свобода и горизонт по курсу. И с тобой я хотел бы жить ее вечно!";
		...
		case "LongHappy_4":
			...
			link.l1 = "За тебя, моя любовь! И за наше будущее вместе, то ли еще будет!!";
		...
		case "LongHappy_7":
			...
			link.l1 = "Лиззи, я тебя в любом наряде люблю, а они - пусть смирятся, не впервой. Но, я как раз хотел посоветоваться с тобой о гостях и церемонии.";
			link.l1.go = "LongHappy_8";
		break;
		
		case "LongHappy_8":
			dialog.text = "Да, тут есть проблема - большинство тех, с кем мы с радостью разделили бы этот день, в город на пушечный выстрел не подпустят, не то, что в церковь. Поэтому - давай обвенчаемся здесь, ну как положено, а потом махнем на Исла Тесоро и устроим там настоящий праздник, что скажешь?";
			link.l1 = "Звучит отлично! Так и поступим. С Аббатом Бенуа я поговорю, но нам надо разослать приглашения и еще...";
			link.l1.go = "LongHappy_9";
		break;
		
		case "LongHappy_9":
			dialog.text = "Спокойнее, капитан. Твоя будущая жена подхватит часть твоей ноши! Я устрою все на Исла Тесоро и напишу нашим друзьям, ты только скажи: каким ты видишь этот праздник?";
		...
		case "LongHappy_10":
			...
			dialog.text = "Уютно и по семейному - ты читаешь мои мысли! Нам придется заскочить в Шарптаун, и я все подготовлю. Я уже прикидывала - думаю полсотни бочонков рома и пару десятков бочек вина будет достаточно. Также, на еду и увеселения нам потребуется тысяч триста серебром.";
			link.l1 = "Напомни - почему не ты ведешь корабельные финансы? Я все достану. Заскочу к аббату, и мы отплываем в Шарптаун.";
			link.l1.go = "LongHappy_12";
		break;
		
		case "LongHappy_11":
			pchar.questTemp.LongHappy.BigMarry = "true";
			dialog.text = "Значит, будем кутить как морские волки - сделаем! Нам придется заскочить в Шарптаун, и я все подготовлю. Но тут придется серьезно запастись - думаю, сотни бочонков рома и полсотни бочек вина должно хватить. И на прочие расходы уйдет не меньше пятисот тысяч.";
			link.l1 = "Ну, я не совсем все Береговое Братство имел в виду... А впрочем - давай! Припасы я достану. Вот только заскочу к аббату и мы отплываем в Шарптаун.";
			link.l1.go = "LongHappy_12";
		break;
		...
		case "LongHappy_12":
			...
			AddQuestUserData("LongHappy", "sName", "Элиза");
			LongHappy_MarryGoToBenua();
		break;
		
		case "LongHappy_13":
			dialog.text = ""+pchar.name+", я разберусь с погрузкой, а потом отнесу письма барону и договорюсь с таверной. Ты не успеешь соскучиться?";
			link.l1 = "Я буду стараться изо всех сил! Или - просто полежу на песочке... не думал, что к штурму Тортуги подготовится проще, чем к свадьбе.";
		...
		case "LongHappy_15":
			dialog.text = "Успел отдохнуть, "+pchar.name+"? Представляешь - местные ребята так разгулялись неделю назад, что сожгли 'Старый Дятел', но барон обещал что к нашему приезду ее отстроят больше и лучше, чем была. Об остальном я договорилась, так что можно отчаливать.";
			link.l1 = "Надеюсь, наша свадьба не оставит тут еще пару пепелищ. Эх, а мне ведь нравился местный притон - уютно, антуражно! Ну да ладно, милая, ты права - время не ждет.";
		...
		case "LongHappy_17":
			...
			link.l1 = "Все хорошо, милая, все хорошо. Я тоже волнуюсь - это нормально. Раз гости уже собрались - мне пора к отцу Бенуа. Узнаю, когда будет служба.";
			link.l1.go = "LongHappy_18";
		break;
		
		case "LongHappy_18":
			dialog.text = "Чувствую я, это будет чертовски длинный и непростой день. Ладно - ты иди, "+pchar.name+", а я пока схожу проведаю Яна и Глэдис.";
			link.l1 = "Я рад, что они смогли приехать. Старик Свенсон любит тебя как родную дочь, а мадам Мак Артур и подавно. Хорошо, что сегодня они будут рядом. Иди, и не волнуйся - все будет прекрасно.";
		...
		case "LongHappy_26":
			dialog.text = "";
			link.l1 = "Я - "+GetFullName(pchar)+" беру тебя, Элиза Беатрисс Шарп, в законные жены, и клянусь хранить верность в счастье и в несчастии, в болезни и в здравии, а так же любить и уважать тебя все отпущенные мне дни.";
			link.l1.go = "LongHappy_27";
		break;
		
		case "LongHappy_27":
			dialog.text = "Я, Элиза Беатрисс Шарп, беру тебя "+GetFullName(pchar)+" в законные мужья, и клянусь хранить верность в счастье и в несчастии, в здравии и в болезни, а также любить тебя и уважать все дни жизни моей.";
			link.l1 = "";
		...
		case "LongHappy_31":
			dialog.text = "Элиза Беатрисс "+pchar.lastname+" - а что, звучит, да муж мой?";
		...
		case "LongHappy_32":
			...
			link.l1 = "Так и сделаю, дорогая. Один поцелуй и я пошел!";
		...
		case "LongHappy_36":
			dialog.text = "О да, муж мой, ты знаешь толк в романтике! И не дергайся так - я теперь имею право целовать тебя на публике... Вот, теперь пошли!";
			link.l1 = "Главное - не забыть приказать снятся с якоря...";
		...
		case "LongHappy_39":
			dialog.text = "Давай, "+pchar.name+". Этот брехун и в стену не попадет!";
			link.l1 = "";
		...
		case "LongHappy_41":
			dialog.text = "Я в порядке, "+pchar.name+", все хорошо. Как Натан? Что с ним?";
		...
		case "LongHappy_44":
			dialog.text = ""+pchar.name+", ты цел? Ну и бойня... Прости - нас задержали - целая дюжина этих крыс пряталась под шканцами. Пришлось с ними повозиться!";
		...
		case "LongHappy_45":
			dialog.text = "Хорошо, муж мой - давай, заканчивай тут и возвращаемся. Мне не дает покоя Натан, как он там? Он ведь меня прикрыл от того выстрела.";
			link.l1 = "Ты права, милая, я тоже о нем беспокоюсь. Иди - я сразу за тобой.";
		...
		case "LongHappy_47":
			dialog.text = "Не беспокойся, любимый, барон Тиракс еще всех нас переживет. Только очнулся и уже буянить - требует саблю и на мостик.";
			link.l1 = "Узнаю старину Маркуса. Пусть отдохнет пока. А мы пока закончим здесь, и на берег.";
		...
		case "LongHappy_49":
			...
			else
			{
				...
				{
					dialog.text = "Мне так жаль Джино, "+pchar.name+"!! Я как узнала не поверила! Как ты, любимый?";
		...
		case "LongHappy_50":
			dialog.text = "Все это необходимо как следует запить, вот что я думаю. Пойдем, Данни нашла нам домик тут на окраине - не хочу сейчас возвращаться на корабль. Посидим, помянем наших друзей, как подобает.";
			link.l1 = "Да, Лиззи, пойдем.";
		...
		case "LongHappy_52":
			...
			{
				dialog.text = "Повидался с Хоуком, или Данни тебя не пустила? Она и меня выставила, когда Джино сказал, что опасность миновала. Хорошо, что все обошлось. Друзья живы, а враги мертвы - славный подарок к свадьбе!";
		...
		case "LongHappy_53":
			dialog.text = ""+pchar.name+", я понимаю, что ты на ногах, наверное, еле держишься, но я была в таверне, и, представь, чего я наслушалась от местного халдея?";
			link.l1 = "Да, я только от Яна узнал - он сюда тоже приходил. Сдается мне, наш суровый маског пошел вразнос. Давай как прогуляемся до бухты Сабу Матила - кое-кто видел его, ушедшего в том направлении.";
		...
		case "LongHappy_55":
			dialog.text = "Ну Тичингиту, ну герой! Я едва со смеху не лопнула! Почему этот прекрасный обычай нынче не в ходу, а? Ладно - ты уже спишь на ходу, любимый. Пойдем, Данни нашла нам домик тут на окраине - тебе надо отдохнуть.";
			link.l1 = "Веди... кажется, я заснул еще на том пляже.";

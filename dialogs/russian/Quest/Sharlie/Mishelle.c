	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (CheckAttribute(pchar, "questTemp.Mtraxx") && pchar.questTemp.Mtraxx == "fail" && CheckAttribute(pchar, "questTemp.Mtraxx.CharleePrince")) // пиратская линейка провалена или пройдена не полностью, но дальше 4 квеста
			{
				...
				link.l1 = "Догадываюсь, что это были за слухи. Но всё в прошлом: я не намерен больше работать с Тираксом. Грязные делишки - это не мое.";
				link.l1.go = "saga_17f";
				break;
			}
			...
			dialog.text = "Что-то еще, "+pchar.name+"? Я думал, мы уже всё обсудили. Не теряй времени: оно очень дорого стоит!";
		...
		case "Mishelle_prisoner_1":
			dialog.text = "Да, чёрт тебя дери...";
			link.l1 = "Я пришёл сообщить о смерти вашего брата Шарля де Мора и передать его личные вещи!";
...
case "Mishelle_prisoner_05":
		...
		case "Mishelle_prisoner_10":
			dialog.text = "Если бы я не был за решеткой, и не был связан обязательствами перед Орденом, я бы заработал их за полгода-год, максимум - полтора. " + GetFullName(pchar) + ", здесь Новый Свет, здесь всё иначе. Активный и предприимчивый человек способен сделать тут состояние, и на это не уйдет вся жизнь, как в Европе.";
		...
		case "Mishelle_prisoner_11":
			dialog.text = "Не говори чепухи, "+pchar.name+"! Пуанси ни за что не выпустит меня отсюда. Если бы всё было так просто, я бы не просил тебя о помощи.";
		...
		case "Mishelle_prisoner_18":
			dialog.text = "Значит, пришло время им стать. Другого пути у тебя всё равно нет. Ты же не думал работать клерком в портовой конторе или записаться в гарнизон? Нет? Значит, станешь капитаном.";
		...
		case "Mishelle_prisoner_22":
			dialog.text = "После того, как купишь корабль, найми команду. Сам ты пока не сможешь управляться с кораблем, так что тебе потребуется штурман. Обо всём этом поговори с хозяином таверны - он тебе поможет. Ну и сам не теряйся, конечно. Когда выйдешь в море, сразу бери курс на Гваделупу...";
		...
		case "Mishelle_prisoner_25":
			...
			link.l1 = "Понял. Ох, и за что же мне всё это наказание...";
		...
		case "Mishelle_prisoner_27":
			dialog.text = "Нет-нет, что ты... Всё, "+pchar.name+", не теряй времени понапрасну. Что делать - ты знаешь. Жду тебя с Гваделупы уже капитаном собственного корабля и с деньгами от Фадея. Удачи. Я надеюсь на тебя.";
		...
		case "Mishelle_prisoner_29": // Addon 2016-1 Jason пиратская линейка 1
			dialog.text = "Хех! "+pchar.name+" сразу даже кошки не родятся. ''Хочу всё и сразу'' - это подход глупых зеленых юнцов, не видевших жизни, и многих он свел за решетку, или даже на тот свет. Зрелый человек понимает, что всего надо достигать постепенно. Впрочем, пёс с тобой. Есть один вариант.\nВ церкви Форт де Франса ты можешь найти аббата Бенуа. Это друг моего отца и мой хороший знакомый. Иди к нему, представься, расскажи обо мне, упади ему в ноги и попроси дать денег в долг. Глядишь, он разжалобится, пожалеет твою зеленую неопытность и ссудит тебе некоторую сумму.";
			link.l1 = "Вот это совсем другое дело! Иду к аббату.";
			link.l1.go = "Mishelle_prisoner_31";
			link.l2 = "Начать с того, чтобы еще больше увеличить твои долги? Ты за кого меня держишь, Мишель? Ясно, помощи от тебя ждать не стоит. Всё сделаю сам!";
		...
		case "trial_13":
			dialog.text = "И тебе придется использовать эти методы, "+pchar.name+". Тем более, что это гласно и негласно поощряется действующей властью. Но даже если ты будешь просто торговать, ты всё равно, рано или поздно, столкнешься с необходимостью вступить в бой, с пиратами или испанскими рейдерами, поскольку ты для них - добыча\nТак что чем быстрее ты откажешься от своих прежних взглядов на жизнь, тем лучше для тебя же самого. Поверь, друг, можно сделать многое, и при этом не только ''сохранить лицо'', но еще и получить благосклонность властей и любовь простого народа.";
			link.l1 = "Я всё более и более удивляюсь, Мишель. Теперь ты призываешь меня пиратствовать. Что будет дальше?";
			link.l1.go = "trial_14";
		break;
		
		case "trial_14":
			dialog.text = "Не драматизируй, "+pchar.name+". На самом деле всё просто: или ты, или тебя. Вот и вся философия. Я предпочитаю первое, и хочу, чтобы ты последовал моему примеру. И я призываю тебя не к пиратству, а к военным действиям против враждебной державы, и то, когда в этом есть смысл.";
			link.l1 = "Выгода, ты хотел сказать?";
			link.l1.go = "trial_15";
		break;
		
		case "trial_15":
			dialog.text = "Ты схватываешь всё буквально на лету. Но довольно слов. Пора применить полученные знания на практике. Жду тебя через три месяца. Думаю, этого времени тебе будет достаточно для знакомства с регионом и заработка небольшого капитала\nНо если ты это время проведешь, шатаясь по кабакам и борделям, либо в бесцельном хождении между островами, и ничему не научишься - лучше сюда даже и не показывайся. Мы поняли друг друга, "+pchar.name+"?";
		...
		case "trial_17":
			...
			link.l1 = "Опять нравоучения... Господи, да когда же это закончится? Ладно, Мишель... я пошёл?";
			link.l1.go = "trial_18";
		break;
...
GiveItem2Character(sld, "mushket1");
	...
	LAi_SetOwnerTypeNoGroup(sld);
  	...
  	pchar.questTemp.piratesLine = "begin"; //Пиратская линейка доступна для взятия
		...
		case "gambit":
			...
			{
				link.l1 = "Не могу понять, как расценить твои слова: как похвалу или как оскорбление. Но, скажу по правде: мне всё равно, что ты там обо мне думаешь. Я собрал миллион в оплату твоего долга, так что скоро ты будешь на свободе. Где я могу найти де Пуанси?";
				link.l1.go = "gambit_1_1";
			}
			else
			{
				link.l1 = "Не могу понять, как расценить твои слова: как похвалу или как оскорбление. Но, скажу по правде: мне всё равно, что ты там обо мне думаешь. У меня ворох... нет, море дел, и мне некогда вступать тут с тобой в полемику и разводить склоки. У тебя есть что сказать по существу? Если нет - то я пошёл...";
				link.l1.go = "gambit_1";
			}
		break;
		...
		case "gambit_4":
			...
			link.l1 = "Знаешь, я как-то не рассчитывал делать военную карьеру во французском флоте. Не дай Бог, закончу как ты - в камере за какое-нибудь невыполненное задание... Ну что же, мне всё понятно. Штаб-квартиру Голландской Компании я, думаю, найду легко, а вот как искать остальных - ума не приложу.";
			link.l1.go = "gambit_5";			
		break;
		...
		case "saga":
			switch(pchar.questTemp.HWIC.Detector)
			{
				...
				case "eng_win": sTemp = "Я нашёл того самого английского капера, Ричарда Флитвуда, выполнил несколько заданий во славу флота Англии, в частности, ликвидировал пиратский ''корабль-призрак'' и разделался с самим Лукасом Роденбургом, вице-директором Компании. Кроме того, у меня теперь на Антигуа свой личный дом, и в кармане позвякивают деньжата..."; break;
				
				case "eng_win_half": sTemp = "Я нашёл того самого английского капера, Ричарда Флитвуда, выполнил несколько заданий во славу флота Англии, в частности, ликвидировал пиратский ''корабль-призрак''. Правда, Флитвуд отбыл в Англию и моя служба у него окончилась, но всё же..."; break;
				...
				case "self_win": sTemp = "Я нашёл ''тайную организацию'' на Барбадосе, стал вести свою собственную игру и добился немалого: уничтожил того английского капера, Ричарда Флитвуда, отправил за решетку Лукаса Роденбурга, вице-директора Компании, стал близким другом губернатора Матиаса Бека и директора Питера Стайвесанта. Кроме того, у меня теперь на Антигуа свой личный дом, и в кармане позвякивают деньжата..."; break;
				
				case "self_fail": sTemp = "Я нашёл ''тайную организацию'' на Барбадосе, стал вести свою собственную игру, однако в самый ответственный момент всё пошло прахом..."; break;
				
			}
			dialog.text = "И? Давай, дружище, не тяни. Что у тебя получилось? До меня доходили отголоски слухов о твоей бурной деятельности, но я хотел бы услышать всё из твоих уст.";
			link.l1 = sTemp;
			link.l1.go = "saga_1";	
		break;
	...
	LocatorReloadEnterDisable("SantLous_town", "reload10", false);
		...
		case "saga_5":
			...
			link.l1 = "Сдается мне, Мишель, что ты всё знал, только не хотел заранее мне это сообщать. Уж больно всё гладко получается... Сначала деньги, теперь - твоя работа... Так случайно не бывает.";
			link.l1.go = "saga_6";
		break;
		...
		case "saga_16":
			dialog.text = "Ты отлично усвоил все уроки жизни, "+pchar.name+". Я искренне рад за тебя. И рад тому, что ты всё-таки взялся за поручение де Пуанси, а не бросил меня. Надеюсь, у тебя всё получится, и ты сумеешь выполнить то, чего так и не смог сделать я.";
		...
		case "Base_afterfight":
			...
			link.l1 = "Расслабляться пока рано - город очищен, но мерзавцы засели в форте, а у берегов острова стоит серьезная эскадра во главе с линейным кораблем. Но всё же сообщу тебе радостную весть, Мишель: ты свободен!";
		...
		case "Base_afterfight_2":
			dialog.text = "Я до самого последнего момента сомневался... и напрасно. Ты превзошёл меня, "+pchar.name+", и преуспел там, где я потерпел сокрушительное фиаско.";
		...
		case "Victory_3":
			dialog.text = "Смотрю на тебя, и поражаюсь: столько силы во взгляде, уверенности в движениях, стати в осанке... и куда только подевался жалкий неудачник? Да! Ты превзошёл все мои самые смелые ожидания и, право, я не предполагал, что ты станешь... таким\nЭто меня даже немного... пугает. Ведь ты ни перед чем не остановишься для достижения поставленной цели. Ты стал хорош, слишком хорош...";
		...
		case "Victory_5":
			...
			link.l1 = "О твоей службе у Пуанси. О каком-то индейском золоте, которое ты ему вез. Обо всём, что предшествовало твоему заключению. Ты многого недоговаривал мне, Мишель, фактически используя меня втемную. Так что...";
			link.l1.go = "Victory_6";			
		break;
		
		case "Victory_6":
			dialog.text = "Я прекрасно помню свои слова. Я всё тебе расскажу. Но не посреди улицы же в горящем городе!\nУ нас у обоих сейчас много дел: тебе нужно заняться своей эскадрой - отремонтировать и подготовить корабли к выходу в море, мне вместе с губернатором - организовать и успокоить жителей, и привести Форт де Франс в терпимое состояние\nА завтра утром мы стобой спокойно всё обсудим за стаканчиком доброго французского вина. Поверь, у меня большие планы, дружище. Очень большие. Но всему свое время. Приходи завтра к девяти утра в церковь к аббату Бенуа. Я остановлюсь на ночь у него, это мой старый друг.";
		...
		case "Victory_8":
			...
			AddSimpleRumourCity("Вы отважный и умелый морской офицер. Все жители Форт де Франс молятся за вас - знайте это!", "FortFrance", 30, 15, "");
			AddSimpleRumourCity("Вы - гордость нашей нации и герой колонии Форт де Франс. Мы никогда этого не забудем!", "FortFrance", 30, 15, "");
			npchar.greeting = "mishelle_0";
		break;
		
		case "kukulkan":
			PlaySound("VOICE\Russian\sharlie\mishelle-04.wav");
			dialog.text = "Вот мы снова и встретились, "+pchar.name+". Несмотря на мое предупреждение, ты всё равно стал искать меня, и твои поиски завели тебя очень далеко...";
		...
		case "kukulkan_1":
			dialog.text = "Эти имена больше не имеют никакого значения, "+pchar.name+". Это всё - прошлое, которое очень скоро исчезнет даже из истории. Наступает момент истины, к которому я шёл долгие три десятка лет с самого своего появления на земле...";
		...
		case "kukulkan_3":
			...
			link.l1 = "Все что угодно мог подумать, но ты... Французский офицер, мальтийский рыцарь, дворянин!";
			link.l1.go = "kukulkan_4";			
		break;
		
		case "kukulkan_4":
			dialog.text = "У нас с тобой разные понятия, "+pchar.name+". Да будет тебе известно, что моя мать - дочь Канека, Шочикецаль. Ее похитили французские каперы во главе с известным в то время капитаном Николя Готьером, когда она необдуманно отлучилась из Тайясаля, и решили продать в рабство. В числе похитителей был человек по имени Серж Бенуа\nУстыдившись злодейств своего капитана, он покинул его, принял постриг и ныне ты знаешь его, как аббата Бенуа. Анри де Монпе, мой отец, в то время - морской офицер, выкупил Шочикецаль и увез с собой во Францию, где она и родила меня. Почти одновременно с этим на свет появился и мой покойный ныне брат Шарль. Его мать умерла после родов, а отец объявил всем, что у его законной жены родилась двойня.\nШочикецаль, моя мать, стала кормилицей для нас обоих. Он вырос на молоке индианки племени ица, "+pchar.name+"! Ну, а дальше его бабка выпросила младенца на воспитание, и за ним оставили фамилию матери - де Мор.";
			link.l1 = "Откуда тебе всё это известно?!";
			link.l1.go = "kukulkan_5";			
		break;
		
		case "kukulkan_5":
			dialog.text = "Разве ты не считаешь, что мне положено знать больше, чем вам? Многое рассказал мой отец, а многое мне известно... Как люди говорят - по наитию.";
			link.l1 = "Теперь всё становится ясно... А что стало с твоей матерью, Шочикецаль?";
		...
		case "kukulkan_10":
			...
			link.l1 = "Получается, из Тайясаля ты шёл уже один?";
			link.l1.go = "kukulkan_11";			
		break;
		
		case "kukulkan_11":
			dialog.text = "Ты имеешь в виду - без солдат Мендосы? Конечно. Все испанцы, кто смог дойти до Тайясаля, были убиты здесь. Сокровища принесли на побережье сами ица, а я сообщил, что солдаты попали в засаду индейцев мискито. Мендоса мне охотно поверил, ибо золото интересовало его намного больше, чем люди\nДальше я планировал подставить корабль с сокровищами под пушки ''Гриффондора'', но всё сложилось проще: барон решил отправить сокровища в Испанию под моим надзором. Лучшего и придумать было невозможно: корабль собирался покинуть Карибское море, что мне и требовалось\nОднако на самом деле капитан ''Санта-Квитерии'' имел другие указания. Размещённая на корабле специальная абордажная рота должна была по выходу в Атлантический океан поднять на корабле мятеж и перебить всю команду и офицеров, включая меня\nДалее капитан с этими людьми должны были вернуть индейские сокровища дону Мендосе. Достойный представитель белой расы, этот Мендоса - не находишь? Мне пришлось пойти на риск: я не знал, когда на корабле вспыхнет бунт. Но всё пошло по плану: шторм налетел, едва ''Санта-Квитерия'' прошла восточную оконечность Тобаго. Фрегат понесло назад, в Карибское море, прямиком к Ксочитэму\nНо тут меня постигла самая крупная неудача в моей жизни: у берегов Мартиники меня смыло огромной волной с палубы корабля в море, и к Ксочитэму ''Санта-Квитерия'' отправилась без меня. Волны вынесли меня на берег, к бухте Ле Марен, где я был подобран рыбаками, которые доставили меня в Ле Франсуа\nПока я приходил в себя у Снейкмана Янга, меня схватили люди де Пуанси - ''Гриффондор'' так и не дождался ''Санта-Квитерию'' там, куда я пообещал ее привести. Шевалье впал в ярость, когда понял, что индейское золото пропало, а деньги из казны Ордена и его личные сбережения пошли прахом\nОн арестовал меня и поместил в каземат подземной базы рыцарей на Мартинике, но не знал, что со мной делать. Убить он меня не мог, да и не хотел. Его интересовали лишь деньги. Деньги! Это единственное, что нужно вам, белым. За них вы сделаете всё... Я оказался в тяжком положении: Ксочитэм с маской так и не был найден, кроме того, я попал в клетку, и без гроша в кармане\nТогда-то я и призвал на помощь брата. Он должен был вызволить меня из казематов, чтобы я смог выполнить свое предназначение. Молоко индианки племени ица, впитанное им в младенчестве, пошло ему на пользу. Однако и тут мне не повезло, ибо Шарль, вскоре после прибытия на Карибы, был убит, как ты хорошо знаешь.\nТем не менее, удача повернулось ко мне лицом и Боги, очевидно, послали тебя, чтобы ты смог помочь мне. А дальше было дело техники. Немного внушения, капелька гипноза и ты как миленький согласился с моими доводами и отозвался на мою просьбу о помощи. В итоге именно ты смог вызволить меня из застенков Ордена и расчистил мне дорогу к заветной цели.";
			link.l1 = "Мне вот интересно, а на что же ты рассчитывал, когда сбежал тогда, из Форт де Франс? Как ты собирался искать Ксочитэм и свою маску?";
			link.l1.go = "kukulkan_12";			
		break;
		
		case "kukulkan_12":
			PlaySound("VOICE\Russian\sharlie\mishelle-05.wav");
			dialog.text = "На тебя. Я же говорю, что Кукулькан умеет читать в человеческих сердцах и даже слегка манипулировать ими. Письмо, оставленное у аббата Бенуа, должно было подстегнуть тебя к действиям. И я не ошибся в тебе. Я неотступно следил за тобой с того самого момента, как ты обратился к инквизитору Сантьяго. Ты сделал всё для меня и за меня. Ты собрал Стража Истины. Ты уничтожил конкурентов. Ты нашёл Ксочитэм\nЯ был там, следом за тобой. Правда, в мои расчеты не входило, что ты проникнешь в Тайясаль, но ты сумел сделать даже это. Ты превзошёл все мои ожидания. И с твоей помощью я сделаю то, для чего родился в теле смертного.";
		...
		case "kukulkan_14":
			dialog.text = "Ха-ха-ха! Мне жаль тебя... Но ты столь геройски шёл к поставленной цели, что я хочу посмотреть, чего ты будешь стоить в битве против Кукулькана!";
			link.l1 = "Может, внутри тебя и дух божества, но тело твое - смертно!";
			link.l1.go = "kukulkan_fight";			
		break;
		...
		case "kukulkan_fail_2":
			dialog.text = "Бедный, бедный капитан "+GetFullName(pchar)+"... Ты прошёл долгий путь, вынес все опасности, преодолел все угрозы, уничтожил столько сильнейших врагов - и лишь для того, чтобы в итоге потерпеть полное поражение!.. Нефритовая маска, которую ты нашёл в металлической коробке у останков ''Санта-Квитерии'' на Ксочитэме - это НЕ МАСКА Кукулькана! Это всего лишь древняя нефритовая маска из сокровищницы Тайясаля\nЯ сам лично вывез ее отсюда после своего неудачного похода: во-первых, на ней лежит заклятие сокровищницы, и именно благодаря ей ''Санта-Квитерию'' захватил шторм при попытке покинуть Карибы и отнес на Ксочитэм, а во-вторых, попав на Ксочитэм, она должна была ввести в заблуждение любого, кто бы явился туда за моим ИСТИННЫМ артефактом.";
			link.l1 = "Но... где же тогда была настоящая маска?! Я же обошёл весь Ксочитэм!..";
		...
		case "kukulkan_fail_6":
			dialog.text = "Отнюдь. Он изменится. Возможно, и тебе найдется в НЁМ местечко, но только ты не будешь знать ничего о том, что происходило в ЭТОМ мире. Кто-то из ныне родившихся так и не появится, кто-то из не появившихся - напротив, увидит свет. Умершие воскреснут, живые умрут, так или иначе - все переродятся. Suum cuique, каждому - свое, "+pchar.name+"\nНе бойся, дружище. Ты не осознаешь своей трансформации и воспримешь бытность в новой реинкарнации, как свою естественную жизнь. И лишь я один, Кукулькан, буду знать о том, что было, и что произошло... Но довольно! Канек уже всё подготовил для обряда\nТы пойдешь со мной к ним, "+GetFullName(pchar)+", и станешь свидетелем последних минут существования ЭТОЙ бытности нашего мира, которую ты так стремился сохранить.";
			link.l1 = "...";
		...
		case "kukulkan_win":
			dialog.text = "Бой еще не окончен, смертный. Ты уже изрядно измотан, а сюда идет подкрепление! Ты всё равно отдашь мне мой артефакт, или я сниму его с твоего трупа - неважно...";
			link.l1 = "...";
			link.l1.go = "exit";

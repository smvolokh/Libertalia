...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "cureer":
			dialog.text = "Капитан 
"+GetFullName(pchar)+", какая удача! Я уже не первый месяц вас ищу!";
		...
		case "cureer_2":
			dialog.text = "Мне передал его один аббат, и попросил доставить капитану "+GetFullName(pchar)+" лично в руки. Я уже отчаялся вас найти и хотел оставить его в портовом управлении в Форт де Франс, но вот удача - вы собственной персоной!";
		...
		case "cureer_4":
			...
			dialog.text = "Приятно иметь с вами дело! Аббат Бенуа передаёт свои наилучшие пожелания! Прощайте, капитан 
"+GetFullName(pchar)+"!";
			link.l1 = "";
			link.l1.go = "cureer_5";
		break;
		...
		case "cureer_7":
			dialog.text = "Значит, заберёте его у начальника порта в Форт де Франс, на Мартинике. Не забудьте предварительно взять кредит. Прощайте капитан "+GetFullName(pchar)+".";
		...
		case "spa_officer":
			dialog.text = "Святой отец, вы сегодня раньше чем обычно. Прошу - ваш эскорт ждёт\nА вы, капитан "+GetFullName(pchar)+" - отец Винсенто узнал, что вы в городе, и настоятельно просит вас присоединиться к нему за ужином.";
		...
		// Ян Свенсон патер
		case "Svenson":
			dialog.text = ""+pchar.name+", поздравляю! Ты знаешь - ты мне всегда нравился, а Элиза мне как дочь, так что я рад за вас. Карамба... ещё не хватало пускать слезу в церкви - старею я что ли?";
		...
		case "Svenson_1":
			...
			link.l1 = "Спасибо, что приехал, Ян. Я очень рад тебя видеть, и для Элизы это много значит.";
		...
		case "Svenson_2":
			...
			dialog.text = "Вот и вы, наконец, "+pchar.name+"! Мой корвет обогнал вас почти на сутки - вполне себе повод для гордости.";
		...
		case "Svenson_4":
			dialog.text = "Определённо! Но, сначала - за тебя и твою лучшую половину! Эй, вы там, а ну тихо все!! Старый Лесной Дьявол сейчас будет речь толкать!\nКхе-кхе... Итак, наши дорогие мсье и мадам... Ай к чёрту! Не умею я так!\n"+pchar.name+", Элиза - вы мне, старику, как дети родные, и, я знаю, что в этом зале нет никого, кто бы всей душой не был рад этому союзу! Так выпьем же, Береговые Братья, за счастье наших верных друзей, за попутный ветер в их парусах и любовь Госпожи Фортуны, столь же крепкую, как их чувства друг к другу!! Будьте!";
		...
		case "Svenson_6_1":
			dialog.text = "Всё путём, "+pchar.name+"?";
			link.l1 = "Отлично, Ян!";
			link.l1.go = "Svenson_6";
		break;
		...
		case "Svenson_8":
			dialog.text = "Элиза? Девчонка снялась с якоря, как только узнала что мы тут затеяли, и унеслась к горизонту. Она передала тебе всякие теплые поздравления, но всё же... наступил ты ей на сердце парень, ох наступил. Впрочем - пройдёт, дело-то молодое.";
		...
		case "Svenson_10":
			dialog.text = "Определённо! Но, сначала - за тебя и твою лучшую половину! Эй, вы там, а ну тихо все!! Старый Лесной Дьявол сейчас будет речь толкать!\n"+pchar.name+", Мэри, всё Береговое Братство сейчас поднимает кубки в вашу честь! Счастье верных друзей радует душу любого морского волка, почти так же как блеск испанского золота, ха-ха! Попутного ветра и семь футов под килем на вашем семейном пути!! Будьте!";
			link.l1 = "Будем, спасибо Ян... ух, этот ром и впрямь забористей чем обычно... Что Натан в него подмешал?";
		...
		case "Svenson_12":
			dialog.text = "Ну что, "+pchar.name+", как тебе праздник?";
		...
		case "Svenson_15":
			dialog.text = "Они с Данни ушли куда-то. Дай девочкам поболтать, "+pchar.name+", а нам пора уже начинать праздновать по-настоящему. Дуй в подвалы, пока я тут распоряжусь насчёт горячего. Если нос меня не подводит - скоро нам подадут бараньи угли вместо рёбрышек.";
		...
		case "Svenson_17":
			dialog.text = ""+pchar.name+", Натан, что с вами, вы что устроили дуэль по пьяни!?";
		...
		case "Svenson_18":
			dialog.text = "Отряд? Ты о чём вообще?! Маркус, поди сюда! "+pchar.name+", давай, рассказывай по порядку.";
		...
		case "Svenson_22":
			dialog.text = "А вот и наш усталый герой! Да,  "+pchar.name+" - это было что-то с чем-то! Ну Жак, ну рыбина! Как он всё устроил - почти ведь получилось!";
		...
		case "Svenson_26":
			...
			{
				dialog.text = "Крепись, "+pchar.name+", что тут скажешь. Мне искренне жаль твоих ребят. Сегодня много хороших парней полегло, и Барбазону за каждого из них черти в аду подольют масла в котёл.";
			...
			else
			{
				...
				{
					dialog.text = "Значит тот тихоня-медик? Мне жаль, "+pchar.name+", искренне. Хороший был парень.";
		...
		case "Svenson_39":
			dialog.text = "Вот, вроде бы и всё. Могло быть гораздо хуже. Даже свадьба у тебя, "+pchar.name+", вышла... боевая. Главное - вы оба живы. Совет, в общем, да любовь!";
		...
		case "Svenson_45":
			dialog.text = "Выглядишь получше, "+pchar.name+". Удалось выспаться?";
		...
		case "Svenson_52":
			...
			link.l1 = "Вот уж не ожидал я что всё так повернётся. Ладно, раз вы и впрямь так решили - быть по сему. Пиратский барон "+GetFullName(pchar)+"! Снова, хех...";
		...
		// Глэдис
		case "Gladis":
			dialog.text = "Юноша, вы сегодня выросли в моих глазах ещё больше. Вы столько сделали для Элизы, что никаких слов благодарности не хватит. Надеюсь, лишь, что вы будете беречь её и дальше. Если бы её отец был жив и видел это, как бы он был счастлив... простите.";
			link.l1 = "Всё в порядке Глэдис. Я благодарен вам, что вы пересекли архипелаг чтобы поддержать Элизу в этот день. Мы оба очень ценим ваш с Яном приезд, спасибо.";
			link.l1.go = "Guests_block";
		break;
		
		// Форже - патер Мэри
		case "forge":
			dialog.text = "Мсье "+pchar.lastname+", мы так и не перешли на 'ты', так что прошу прощения за фамильярность, но я скажу это - "+pchar.name+", я искренне за тебя рад! Если я могу что-то сделать для тебя или твоей невесты, только скажи!";
			link.l1 = "Благодарю вас, барон, я счастлив и так, а мои финансовые дела за время пребывания в Новом Свете изрядно поправились.";
			link.l1.go = "forge_1";
		break;
		
		case "forge_1":
			dialog.text = "Да, полагаю, вы можете себе позволить почти всё, что захотите, "+pchar.name+". Но, разрешите, я внесу свой вклад, как посаженный отец невесты - сегодня же я отпишу своему доброму другу министру финансов. Ваша избранница будет пожалована дворянским титулом, и, я думаю, мы подберём какое-нибудь неплохое имение, скажем в Гаскони, из числа изъятых за долги, и припишем Вам задним числом.";
			link.l1 = "Не сказать, чтобы мне было дело до таких сплетен, но спасибо, барон. Право не стоило.";
			link.l1.go = "forge_2";
		break;
		
		case "forge_2":
			dialog.text = "Ещё как стоило! А теперь идите, "+pchar.name+", уделите внимание остальным гостям. И ещё раз примите мои самые искренние поздравления!";
		...
		case "forge_4":
			dialog.text = "Как бы я мог его не принять, "+pchar.name+"! Но, послушайте - я хочу сделать вам с вашей прекрасной невестой достойный подарок, но не могу придумать ничего, что вы бы не смогли добыть себе деньгами или шпагой. Потому - я отпишу своему другу министру финансов в Париж, и, к тому времени, как вы прибудете в Европу, Ваша избранница будет пожалована дворянским титулом, и, я думаю, мы подберём какое-нибудь неплохое имение, скажем в Гаскони, из числа изъятых за долги, и припишем Вам задним числом.";
			link.l1 = "Не знаю, что сказать, барон... Искренне благодарю.";
			link.l1.go = "Guests_block";
		break;
		
		// Форже гость
		case "forge_5":
			dialog.text = ""+pchar.name+", примите мои искренние поздравления! Ваша избранница просто чудо! Думаю, колониальная мода сегодня получила крепкий... тычок в новом направлении. Ваша оригинальность всегда меня восхищала! Совет да любовь вам и вашей прекрасной половине!";
			link.l1 = "Благодарю, барон. Вы оказали нам честь своим визитом.";
			link.l1.go = "forge_6";
		break;
		
		case "forge_6":
			dialog.text = "Пустое, друг мой - как бы я мог остаться в стороне? Мы с вами многое пережили, и, пусть и не перешли на 'ты', но я горд считать вас своим другом, "+pchar.name+". Помните - мои двери для вас всегда открыты, что бы ни случилось.";
			link.l1 = "Как и двери нашего семейства открыты для вас, барон.";
			link.l1.go = "Guests_block";
		break;
		
		// Пуанси патер Мэри
		case "puancie":
			dialog.text = ""+pchar.name+", мой друг, это весьма важный день, и я рад, что вы пригласили меня разделить его с вами. Мы с вами прошли долгий и непростой путь, и быть посаженным лицом мадемуазель... прошу простить - мадам, это честь для меня, поверьте. От всей души я желаю вам счастья!\n- И прошу, дайте мне знать, когда соберётесь в Европу - я, как генерал-губернатор, пошлю прошение о присовении вашей семье обширного надела где-нибудь в Гаскони, например!";
		...
		// Пуанси патер ГГ
		case "puancie_2":
			dialog.text = ""+pchar.name+", мой друг, это весьма важный день, и я рад, что вы пригласили меня разделить его с вами. Мы с вами прошли долгий и непростой путь, и свидетельствовать сегодня на вашей свадьбе - честь для меня. От всей души я желаю вам счастья! И прошу, дайте мне знать, когда соберётесь в Европу - я, как генерал-губернатор, пошлю прошение о присовении вашей семье обширного надела где-нибудь в Гаскони, например!";
		...
		case "puancie_3":
			...
			dialog.text = "Как я уже сказал - это честь для меня! Но, постойте, мой друг, я хотел бы кое-что вам преподнести по такому случаю - уверен это порадует и вас и вашу избранницу. Отличные камни из наших приисков Новой Гвианы - подберите им достойную оправу и Ваша жена затмит всех даже на королевском приёме! Если вы таки убедите её надеть платье, конечно...";
		...
		// Пуанси гость
		case "puancie_4":
			dialog.text = ""+pchar.name+", мой друг, позвольте вас поздравить! Мы с вами прошли долгий и непростой путь, и я искренне рад быть сегодня здесь. Господь свидетель - вы заслужили своё счастье! Храните его и оберегайте - совет да любовь!";
		...
		// Фадей патер
		case "fadey":
			dialog.text = ""+pchar.name+", вот это празднество, и сколько важных лиц! Позволь от всей души пожелать тебе счастья супружеского и здоровья крепкого, и детей на радость! Как у нас говорят - 'горько'!";
			link.l1 = "Благодарю, Фадей, ты оказал мне честь, согласившись приехать.";
			link.l1.go = "fadey_1";
		break;
		
		case "fadey_1":
			dialog.text = "Правда, я не совсем понимаю, зачем 'свидетели' - будто мы не брак заключаем, а сделку какую, да и медведей с водкой, на мой вкус, тут маловато.. ха-ха! Да шучу я, "+pchar.name+", что ты с лица то опал весь? Дай обниму тебя, женатый ты капитан!";
		...
		case "fadey_2":
			...
			PlaySound("interface\important_item.wav");
			dialog.text = "Погоди, "+pchar.name+", не отходи - негоже гостю, даже 'свидетелю' на свадьбу без даров приходить. Вот, возьми. Я знаю - ты постарался, чтобы все эти клинки найти, и, некоторые, тебе явно глянулись. Так прими же их - повесь в имении родовом и вспоминай добрым словом Фадея Московита!";
			link.l1 = "Вот это подарок! Спасибо, Фадей. Это и впрямь прекрасное оружие, и оно займёт достойное место в нашем поместье, обещаю!";
			link.l1.go = "Guests_block";
		break;
		
		// Фадей гость
		case "fadey_3":
			dialog.text = ""+pchar.name+", какое доброе торжество, и сколько важных лиц! Позволь же от всей души пожелать тебе счастья супружеского и здоровья крепкого, и детей на радость! Как у нас говорят - 'горько'! Дай обниму тебя, женатый ты капитан!";
			link.l1 = "Ох... Фадей - хватка у тебя медведю на зависть! ";
			link.l1.go = "Guests_block";
		break;
		...
		// Проспер Трубаль
		case "Prosper":
			dialog.text = ""+pchar.name+", я не мог это пропустить - поздравляю от всего сердца тебя и твою избранницу! Будьте счастливы! Знаешь, я пару месяцев назад дочку выдал за хорошего человека и по любви, но, признаюсь, жалел, что это был не ты. Ну да ладно... что это я - поздравляю! Совет да любовь!";
		...
		case "FortFrance_Mayor":
			...
			{
				dialog.text = "Отличное... торжество, очень рад за вас, "+pchar.name+". Хотя, я, всё-таки, вас не понимаю... Держать в руках бесценную розу, и променять её на... полевой цветок. Но - сердцу не прикажешь. Будьте счастливы, друг мой. Совет да любовь!";
		...
		case "FortFrance_Mayor_1":
			dialog.text = "Постойте, "+pchar.name+". Вы меня не так поняли - я искренне, и всем сердцем за вас рад! И да... вот, возьмите. Один наш общий... друг, очень просил, чтобы вы это получили именно сегодня.";
		...
		// Бас Тер
		case "BasTer_Mayor":
			dialog.text = "Восхитительная литургия, не правда ли, мсье "+pchar.lastname+"? Я искренне за вас рад! От меня лично и всех горожан Бас-Тер - передавайте поздравления вашей... очаровательной супруге. Вы чудесная пара! Совет да любовь!";
		...
		// Порт Принс
		case "PortPax_Mayor":
			dialog.text = "Просто чудесная служба, мсье "+pchar.lastname+", просто чудесная! И невеста такая... оригинальная в этом наряде. От лица всех жителей Порт-о-Пренса, прошу - примите мои самые искрение поздравления! Совет да любовь!";
		...
		// Тортуга
		case "Tortuga_Mayor":
			dialog.text = "Очень мило - вы и ваша супруга, мсье "+pchar.lastname+", смотрелись так необычно! Впрочем - вы и человек необычный. Желаю вам долгой и счастливой семейной жизни. Совет да любовь!";
		...
		case "Terrax":
			if (CheckAttribute(pchar, "questTemp.Mtraxx")) 
			{
				...
				{
					dialog.text = "И что этот женатый франт делает на моем пиратском берегу а?! Признавайся, мусью, что ты сделал с моим старым другом - суровым кэпом по прозвищу "+pchar.name+" Барон?";
					link.l1 = ""+pchar.name+" Барон умер, ты же помнишь, Маркус. Здравствуй, рад тебя видеть! Как тут у вас, все уже собрались? А где твой знаменитый 'Красный дракон', что это за лоханка на рейде стоит?";
					link.l1.go = "Terrax_1_1";
				}
				else // 28-03-20
				{
					dialog.text = "И что этот женатый франт делает на моем пиратском берегу а?! Признавайся, мусью, что ты сделал с моим старым другом - суровым капитаном по имени "+GetFullName(pchar)+"?";
		...
		case "Terrax_3":
			pchar.questTemp.LongHappy.Count = sti(pchar.questTemp.LongHappy.Count)+1;
			dialog.text = "Женатый "+GetFullName(pchar)+" - до сих пор не могу привыкнуть к этой мысли... Сначала Свенсон, теперь и ты - дальше что? Пастор Марлоу, или Добряк Жак?";
		...
		case "Nathaniel":
			pchar.questTemp.LongHappy.Count = sti(pchar.questTemp.LongHappy.Count)+1;
			dialog.text = "Женатый капитан "+GetFullName(pchar)+", нечасто я встречал более душевные поводы для тоста. Хватай бокал - это не обычное кабацкое пойло - настоен на чёрном чае из Ост Индии и приправлен настоящими персидскими специями!";
			link.l1 = "То-то от него жжёт в горле словно свинца расплавленного глотнул. Ну, Натан, будем...";
			link.l1.go = "Nathaniel_1";
		break;
		
		case "Nathaniel_1":
			dialog.text = "Погоди, сначала тост! Эй, джентльмены, а ну подняли кружки! Сегодня, наш друг и соратник "+GetFullName(pchar)+" вступает на тропу семейной жизни. Прими от нас самые глубокие соболезн... ох, Данни, отпусти пистолет! Поздравления, конечно же! Вы теперь - паруса на одном корабле, так ведите же его через любые бури к самым благодатным берегам!";
		...
		case "Nathaniel_10":
			dialog.text = "Да что здесь творится, что это за подонки? Ты что-нибудь понимаешь, "+pchar.name+"?";
		...
		case "Nathaniel_18":
			...
			dialog.text = "Мы в порядке, "+pchar.name+"! Сейчас я её развяжу. Я слышу пушки в гавани - вам с Натаном надо туда, иначе Барбазон перетопит наши суда, как утят в бочке. Нельзя терять ни минуты!";
		...
		case "Nathaniel_19":
			dialog.text = ""+pchar.name+", быстрее. Что бы ты ни решил, время сейчас на вес золота! Если корабли Жака прорвутся к берегу, всё будет напрасно!";
		...
		case "Nathaniel_21":
			dialog.text = "Проклятье, прости, "+pchar.name+", мы застряли наверху - там под шканцами пряталась ещё дюжина этих... Жаль, я не успел, но, гляжу, ты справился в лучшем виде.";
		...
		// Даниэль Хоук
		case "Danielle":
			dialog.text = "Ну здравствуй, "+pchar.name+". Дай-ка я на тебя посмотрю - похорошел, нечего сказать! Почти как Натан, лет десять назад! Да ты проходи, не стой на пороге - здесь все только вас и ждали!";
		...
		case "Danielle_4_1":
			dialog.text = "Вы прекрасная пара, "+pchar.name+"!";
			link.l1 = "Спасибо, Данни...";
			link.l1.go = "Danielle_4";
		break;
		
		case "Danielle_5":
			dialog.text = ""+pchar.name+", он прав... выбора у вас нет. В милосердие Жака Добряка, если он расправится с Тираксом и остальными, я не верю. Вы знаете, что делать.";
			link.l1 = "";
		...
		case "Danielle_9":
			dialog.text = "Да, "+pchar.name+", он жив! Сердце едва бьётся, но он жив! Что нам делать?!";
			link.l1 = "Нам нужен Джино, немедленно! Я найду его и отправлю сюда, он поможет... должен, чёрт возьми!";
			link.l1.go = "Danielle_10";
		break;
		
		case "Danielle_10":
			dialog.text = ""+pchar.name+", счёт идёт на минуты! Если корабли Жака прорвутся к берегу, всё будет напрасно! Мой муж... он сделал что должен был. Теперь твой черёд. Я останусь с ним.";
		...
		case "Danielle_12":
			...
			{
				dialog.text = "Он в порядке - твой врач-итальянец просто гений! Сейчас Натан спит наверху, но, по словам Джино, ему ничего не угрожает. Неделька-другая в постели, красное вино, и, как он там сказал... 'визит благорасположенной к нему дамы', кхм. В общем - всё хорошо, ты опять нас спас, "+pchar.name+", как мне тебя благодарить?";
		...
		case "Danielle_14":
			dialog.text = "Конечно, "+pchar.name+", но... у меня есть и плохие новости. Тот итальянец, Гвинейли, кажется, который был на твоей свадьбе... Его нашли в комнате в таверне. Мне... мне очень жаль, "+pchar.name+".";
		...
		case "Danielle_16":
			...
			dialog.text = "Прости, "+pchar.name+". Тут была чёртова мясорубка, а он совсем не вояка... Если хочешь - мы отправим тело на твой корабль, отвезёшь его домой и похоронишь как подобает. Я правда сожалею...";
		...
		case "Danielle_17":
			...
			{
				dialog.text = "Мне очень жаль, "+pchar.name+". Я нашла нашего хирурга с ''Центуриона'', но он ничего не смог сделать... Твой парень скончался пару часов назад.";
		...
		case "Danielle_22":
			...
			dialog.text = "Соболезную, "+pchar.name+"... Если хочешь - мы отправим тела на твой корабль, отвезёшь ребят домой и похоронишь как подобает. Я правда сожалею...";
		...
		case "Dodson":
			pchar.questTemp.LongHappy.Count = sti(pchar.questTemp.LongHappy.Count)+1;
			dialog.text = ""+pchar.name+", ты хоть представляешь, сколько девичьих сердец ты разбил этой своей свадьбой? Да половина девок архипелага, должно быть, надела траур после вашего венчания, ха!";
			link.l1 = "Что поделать - мне нужна лишь одна, и я её получил. Но девкам рано расстраиваться, ведь у них ещё есть ты, Стивен!";
			link.l1.go = "Dodson_1";
		break;
		
		case "Dodson_1":
			dialog.text = "И то верно! Вот закончим балагурить тут и сразу же займусь, чёрт побери! Давай, "+pchar.name+", выпьем за твою удачу и семейную жизнь. Чтоб, как говорится, долго и счастливо!";
		...
		case "Vensan_3":
			pchar.questTemp.LongHappy.Count = sti(pchar.questTemp.LongHappy.Count)+1;
			dialog.text = "Ха, "+pchar.name+", вот и ты стал женатым и скучным, как наш старина Натан! Горячие делишки и всё прочее теперь в прошлом да? При-мер-ный семьянин!";
		...
		case "Vensan_6":
			dialog.text = "Вовремя ты подоспел, "+pchar.name+", спасибо!";
		...
		case "Knippel":
			...
			if (CheckAttribute(pchar, "questTemp.LongHappy.MarrySP"))
			{
				...
				link.l1 = "Всё прекрасно, Чарли, теперь я официально женат и солиден, а мой старший помощник - моя жена.";
			}
			else
			{
		...
		case "Knippel_2":
			...
			link.l1 = "Чарли, ты воистину щедрая душа, а эти изумруды будут прекрасно смотреться в фамильных серьгах нашего семейства!";
		...
		case "Baker_1":
			sTemp = "Шарптауне";
			if (CheckAttribute(pchar, "questTemp.LongHappy.MarrySP")) sTemp = "Форт де Франс";
		...
		case "Alexus_1":
			dialog.text = "А, господин "+GetFullName(pchar)+" и Натан Хоук собственной персоной! Вы же вроде чью-то свадьбу отмечаете, так? Ладно уж - идите за своим горючим. Молодёжь должна веселиться - это закон в любом времени. Только не гремите бутылками на обратном пути - я собираюсь спать!";
		...
		// Ангерран
		case "Shivo":
			dialog.text = "Мсье "+GetFullName(pchar)+", добрый вечер, или - уже почти утро? Проходите, присаживайтесь.";
		...
		// Дюссак
		case "Dussak":
			dialog.text = "Капитан "+GetFullName(pchar)+", барон Хоук - какой приятный сюрприз! Позвольте представиться - Мориц Дюссак, так меня зовут.";
		...
		// моряки в таверне Форт де Франс
		case "sailor":

...
void ProcessDialogEvent()
{
	...
	{
	Link.l6 = "Теперь ты не офицер, а капитан моего корабля, милая капитаночка, ха, и у меня к тебе есть вопросы?";
	...
	break;
		...
		case "Companion_Tasks":
			dialog.Text = "Благодарю за доверие и я внимательно слушаю мой капитан.";
			...
			{
			    Link.l3 = "Я хочу, чтобы ты на время вышла из состава моей эскадры и поискал удачу самостоятельно.";
		...
		case "Companion_TaskChangeYes":
			dialog.Text = "Будет исполнено мой капитан.";
			Link.l1 = "Вольно.";
			Link.l1.go = "exit";

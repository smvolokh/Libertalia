...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		break;
		case "PL_Q7_5":
			dialog.text = "В море. Вчера он вышел в море на пиратском корвете ''Леон'', насколько мне известно. Сам-то я этого корабля не видел. Этот тип был очень острожен, но его видел один из моих рабочих и рассказал мне.\nИщи его где-то у берегов Эспаньолы. Не думаю, что он успел далеко уйти.";

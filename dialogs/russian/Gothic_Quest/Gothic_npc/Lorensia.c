...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "fugas_5":
			...
			link.l1 = "Ну что же, попробуем. Главное - чтобы они не увидели раньше времени, что ''Пёс Войны'' уже не под командованием братца Джекмана... Черт возьми, это будет нелегко - к ним подобраться. Джекман не такой простак, как Упырь.";
			link.l1.go = "fugas_6";
		break;

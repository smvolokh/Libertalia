	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
	                  ...
	                  PlaySound("VOICE\Russian\gotica\Myxir\DIA_ADDON_MYXIR_GEISTTAFEL_12_10.wav");
            	                   dialog.text = "Здесь написано, что тот кто верит в Аддоноса, может вызвать духа.";
        	                   link.l1 = "Вызвать духа? Как интересно, могу ли я попробовать? Мне как раз нужно найти одного умершего капитана...";
		 ...
		 case "APSH_Myxir_table_4":
	                      PlaySound("VOICE\Russian\gotica\Myxir\DIA_ADDON_MYXIR_GEISTTAFEL_15_11.wav");
            	                       dialog.text = "Да.";
        	                       link.l1 = "Ты думаешь, что это сработает?";
        	                       link.l1.go = "APSH_Myxir_table_5";
		  break;

		 case "APSH_Myxir_table_5":
	                      PlaySound("VOICE\Russian\gotica\Myxir\DIA_ADDON_MYXIR_GEISTTAFEL_12_12.wav");
            	                      dialog.text = "Знаешь, мне в руки попадалось множество бессмысленных манускриптов...";
        	                       link.l1 = "...";
		 ...
		 case "APSH_Myxir_table_8":
	                     PlaySound("VOICE\Russian\gotica\Myxir\DIA_ADDON_MYXIR_GEISTTAFEL_WIE_15_00.wav");
            	                     dialog.text = "...";
        	                     link.l1 = "И что же мне нужно сделать, чтобы вызвать этого духа?";
		 ...
		 case "APSH_Myxir_table_9":
	                      PlaySound("VOICE\Russian\gotica\Myxir\DIA_ADDON_MYXIR_GEISTTAFEL_WIE_12_02.wav");
            	                      dialog.text = "Духа можно вызвать при помощи заклинания стражи мертвых, вот, я записал его.";
        	                     link.l1 = "Отлично, спасибо.";
		 ...
		 Log_Info("Вы получили заклинания стражи мертвых");
            	                      dialog.text = "Это всё, также тебе необходимо выбрать место для вызова духа.";

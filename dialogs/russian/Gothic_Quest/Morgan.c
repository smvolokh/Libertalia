...
// ============================================================================
	switch(Dialog.CurrentNode)
	{
		...
		case "I_know_you_good":
			...
			{
				pchar.questTemp.RevengeCorsair = "End";
				link.l1 = "Слушай, Генри, есть для меня подходящее дельце?";
		...
		case "PL_Q3_GoodWork_2":
			dialog.text = "Понимаешь ли, " + GetFullName(pchar) + ", это отдельный философский вопрос...\n" +
				...
				"Короче, всем не угодишь, и стремиться к этому не стоит. А ты честно заслужил"+ GetSexPhrase("","а") +" свою награду. Держи честно заработанные дублоны. А также в знак моей особой признательности прими эту коллекцию драгоценностей и талисман. И заглядывай ко мне периодически, возможно, скоро для тебя появится работёнка.";
			...
			Log_Info("Вы получили талисман ''Упырь''!");
			PlaySound("interface\important_item.wav");
		break;
		...
		case "PL_Q7_afterLeon":
			...
			link.l1 = "К сожалению, Стив Линней мертв. Его убили пираты с пиратского корвета ''Леон''. Но с ними я уже рассчитал"+ GetSexPhrase("ся","ась") +".";
		...
		case "PL_Q7_afterLeon_2":
			...
			link.l1 = "Нет, Генри. Это Ричард Соукинс, глава Вестпунта.";
		...
		case "PL_Q8_ready_1":
			...
			else
			{
				...
				link.l1 = "Всё ясно, адмирал, всё сделаю.";
				link.l1.go = "exit";
				NextDiag.TempNode = "PL_Q8_ready";
			}
		break;

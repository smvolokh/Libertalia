...
/// ******************** Фредерик Бамер ***********************************
		...
		dialog.text = "Слушай сюда " + GetSexPhrase("парень", "девушка") + ". Благодарю... Письмо у меня... А ты загляни на досуге к ростовщику Форт Оранж и спроси Рэндольфа Кэннелла. Может и для тебя найдется дельце.";
		link.l1 = "Эй, постой!";
...
/// ******************** Монахи ***********************************
		...
		// TODO если страж истины проходится/проходился, то другой диалог
...
/// ******************** Фраера ***********************************
		...
		dialog.text = "Тебе здорово повезло, что ты ещё" + GetSexPhrase("жив", "жива") + ". Нам от тебя ничего не нужно, мы просто выполняем задание Магистра. Он сказал, что тебя арестовали, и сказал где тебя искать.";
		link.l1 = "Что за магистр? Не знаю я никакого магистра! Может кто-нибудь мне объяснит, что вообще происходит?";
		link.l1.go = "Man_in_SantiagoPrison_2";
		break;
		
		case "Man_in_SantiagoPrison_2":
		dialog.text = "Зато он тебя знает от Фредерика Бамера. Ты ему услугу оказал" + GetSexPhrase("","а") + " в порту Пуэрто Принсипе, а он не забывает добра. Ладно, собирайся, будем выбираться из этого логова. Ответы на все свои вопросы получишь непосредственно у самого Магистра, если он сочтёт нужным на них ответить.";
		link.l1 = "Каким образом? У меня нет ни оружия, ни корабля...";
		link.l1.go = "Man_in_SantiagoPrison_3";
		break;
		
		case "Man_in_SantiagoPrison_3":
		dialog.text = "Наверняка твои вещи в одном из сундуков этого мрачного места, не задерживайся здесь, скоро набегут солдаты, забирай свои вещи и беги сразу за город, там получишь инструкции. Не старайся изображать из себя героя - не в твоём положении это делать, просто беги и не оборачивайся.";
		...
		link.l1 = "Спасибо ещё раз.. А ты кто, если не секрет?";
		link.l1.go = "Man_in_SantiagoPrison_6";
		break;
		
		case "Man_in_SantiagoPrison_6":
		dialog.text = "Не секрет, да вот время нет объяснять. Помнишь, что Фредерик Бамер сказал? Вот и сходи к нему в Форт Оранж, там у ростовщика стоит наблюдатель Джейкоб Невил, это наш человек, он пропустит тебя\nПравда, прежде чем показываться к нему на глаза, ты долж" + GetSexPhrase("ен","на") + " сделать еще одно дело, это от меня, личная просьба.";
		link.l1 = "Конечно, что требуется?";
		link.l1.go = "Man_in_SantiagoPrison_7";
		break;
		
		case "Man_in_SantiagoPrison_7":
		dialog.text = "Тебе надо добраться до Тринидад и Тобаго. Найди человека по имени Филип Бличер, он должен быть в одном из домов в городе, он ведёт уединённый образ, поэтому спрашивать в трактире или ещё у кого нет смысла.";
		link.l1 = "Понятно, и что это за человек такой? Зачем мне его искать?";
		link.l1.go = "Man_in_SantiagoPrison_8";
		break;
		
		case "Man_in_SantiagoPrison_8":
		dialog.text = "О, это кровавая история. Он долгое время ходил старшим помощником капитана на одном из испанских торговых судов\nВернувшись из очередного рейса, обнаружил у себя в доме погром. Пропала его любимая жена Агата. В случившемся он подозревает происки Испанской инквизиции\nИ вот, продав все, что у него было, и прослышав про нашу борьбу с этими испанскими 'святошами', он, горя желанием отомстить, прибыл в Новый свет и ищет встречи с Магистром.";
		link.l1 = "Хорошо, я понял" + GetSexPhrase("", "а") + ", найду его, хотя еще сам" + GetSexPhrase("","а") + " не представляю, как буду отсюда выбраться...";
		...
		link.l1 = "Отлично, никак не ожидал" + GetSexPhrase("","а") + ". Нужно будет устроить им небольшую пирушку в таверне, иначе не представляю, что бы сейчас было.";
		link.l1.go = "Man_in_SantiagoPrison_10";
		break;
		
		case "Man_in_SantiagoPrison_10":
		dialog.text = "Хе-хе, ну что ж, удачи тебе, капитан, и не забудь про мою просьбу!";
		link.l1 = "Не забуду, до встречи, и спасибо за помощь.";
		link.l1.go = "exit";
...
/// ********************Филип Бличер***********************************
		...
		case "Apostates_FB_7":
		dialog.text = "Буду с Вами откровенен, Магистр. Прослышав про Вашу борьбу против испанской инквизиции, хочу быть полезен Вам в этом деле. Готов выполнить любое Ваше поручение, какое бы мне ни доверили\nПорукой моего лояльного отношения к Вашему движению будет то, что случилось с моей женой Агатой. Я наверняка уверен, что тут не обошлось без руки инквизиции.";
		link.l1 = "...";
		link.l1.go = "Exit";
...
/// ********************испанский офицер ***********************************
		...
		dialog.text = "Именем губернатора Сан-Хосе, вы арестованы, сеньор" + GetSexPhrase("","ита") + ". Во избежание применения грубой физической силы, я вам предлагаю немедленно проследовать за мной.";
		link.l1 = "А, собственно в чём дело? Я ни в чем не виноват" + GetSexPhrase("","а") + ", хорошо, приказывайте куда идти.";
		link.l1.go = "Apostates_SpOfficerInStJuan_END_GAME";
		link.l2 = "Я сейчас буду вынужден" + GetSexPhrase("","а") + " сам" + GetSexPhrase("","а") + " применить грубую физическую силу, если вы не оставите меня в покое, сеньор комендант. Не успел" + GetSexPhrase("", "а") + "сойти на берег, как мне сразу предъявляют какие-то претензии!";
		...
		dialog.text = "Неразумно.. Теперь у вас точно нет никаких шансов мирно разрешить эту ситуацию. Ну что ж, из города вам все равно не уйти, жив" + GetSexPhrase("ым","ой") + ". Этот дом окружен лучшими бойцами, а при попытке бегства будет открыт огонь на поражение.";
		link.l1 = "И не из такого выбирались...";
		link.l1.go = "Exit";
...
//********************* Джейкоб Невил*****************************
		...
		dialog.text = "Наконец-то, вас уже ждут, капитан. Зайдете в комнату, там спокойно можете пообщаться с ним, а я покараулю, чтобы вам никто не мешал. Одну минутку, сейчас открою дверь.";
		link.l1 = "...";
		link.l1.go = "exit";
		...
		dialog.text = "Разумеется, "+GetAddress_Form(npchar)+", он у себя в кабинете. Он ждал Вас...";
		link.l1 = "...";
		link.l1.go = "Exit";
		...
		case "Apostates_man_APSH":
	                     PlaySound("VOICE\Russian\officer_common_3.wav");
		dialog.text = "Моё почтение, капитан.";
		link.l1 = "Приветствую! Магистр у себя?";
...
//********************* Рэндольф Кэннелл*****************************
		...
		case "second_2":
		dialog.text = "Иди сейчас в магазин, оттуда тебя переправят мои люди в убежище, мы никому не отказываем в своей помощи, если человек действительно в ней нуждается.";
		link.l1 = "...";
		link.l1.go = "Exit";
		...
		link.l1 = "Спасибо за радушный прием и за то, что вытащил меня из места 'истины', долго бы я там не протянул" + GetSexPhrase("","а") + " - это факт.";
		link.l1.go = "second_4";
		break;
		
		case "second_4":
		dialog.text = "Да, знаю, и не таких бойцов там раскалывали, рассказывают даже такое, что и не знали никогда в жизни.";
		link.l1 = "Я бы уж точно рассказал" + GetSexPhrase("","а") + ", не перевариваю пыток, то и дело в честном бою с врагом встретиться...";
		link.l1.go = "second_5";
		break;
		...
		case "second_6":
		dialog.text = "Нет, " + GetSexPhrase("дружище","дорогая") + ", так это трактуют только католические священники, которые избрали себе орудием для истребления инакомыслящих инквизицию\nНаша история уходит своими корнями в глубокое прошлое, начало которого выводится от орденов тамплиеров и гильдий каменщиков XIII века, но последнее яркое событие произошло в XVI веке.";
		link.l1 = "Что за событие?";
		link.l1.go = "second_7";
		break;
		
		case "second_7":
		dialog.text = "Ты наверняка знаешь о той кровавой ночи на праздник Святого Варфоломея..";
		link.l1 = "Я понял" + GetSexPhrase("","а") + ", это ты про Варфоломеевскую ночь говоришь, когда всех гугенотов истребили.";
		link.l1.go = "second_8";
		break;
		
		case "second_8":
		dialog.text = "Ну, не всех. С тех пор нас кем только не называют: вероотступниками, еретиками, сектантами. Поверь, мы такие же, как и все нормальные люди - верим в Спасителя и зла никому не желаем!";
		...
		link.l2 = "Конечно, я в деле, только есть одна проблема, я, всё-таки, капитан корабля, и мне нужно заботиться о благополучии своей команды.";
		...
		dialog.text = "Ну что же, я тебе доверяю и надеюсь, что ты нас не предашь. Удачи тебе. Кстати, возьми компенсацию за твои мытарства, и за то, что доставил ко мне этого бедолагу.";
		link.l1 = "...";
		link.l1.go = "Exit";
		...
		case "second_11":
		dialog.text = "Да пребудут с тобой силы, " + GetSexPhrase("друг","сестра") + " мо" + GetSexPhrase("й","я") + ".";
		link.l1 = "...";
		link.l1.go = "Exit";
		NextDiag.TempNode = "second_11";
		break;
		...
		case "second_12":
		dialog.text = "О, не волнуйся, каждое моё поручение будет щедро оплачиваться. Пока в этих водах нас существенно поддерживает только Голландия, но и этого достаточно для реализации нашей великой цели\nКстати, возьми небольшую компенсацию за твои мытарства, и за то, что доставил ко мне этого беднягу.";
		link.l1 = "...";
		...
		dialog.text = "Вот твоё первое задание - отправляйся к ростовщику в Сан-Хуан. У него есть очень важная информация для нас.";
		link.l1 = "Без проблем. Кстати, ты мне не откроешь тайну, что же всё-таки было в том злополучном письме?";
		...
		link.l1 = "Мне кажется, что не особо-то они печалятся о нем.";
		...
		dialog.text = "Это не прозвище, это звание, которое нужно заслужить. Хватит разговоров, пора действовать.";
		link.l1 = "Понятно. До встречи, Магистр!";
		link.l1.go = "Exit";
		NextDiag.TempNode = "second_11";
		...
		case "second_23":
		dialog.text = "В таком случае, тебе надо отправляться в Порто Белло и попытаться его там перехватить, учти он нам нужен живым как заложник, чтобы Иезуиты пошли с нами на контакт, сделать это нужно тихо, там будут и мои люди\nВ случае успеха, заложника передай им. На задание у тебя около десяти дней, иначе ты его упустишь.";
		...
		case "second_26":
		dialog.text = "Прошу тебя, "+pchar.name+" не медли!";
		link.l1 = "...";
		link.l1.go = "Exit";
		NextDiag.TempNode = "second_26";
		break;
		...
		link.l1 = "Приветствую, Магистр. Я выполнил" + GetSexPhrase("","а") + " ваше поручение.";
		link.l1.go = "second_28";
		break;
		
		case "second_28":
		dialog.text = "Спасибо тебе, капитан, но чувствую, что всё напрасно.";
		link.l1 = "Что случилось? Что за пессимизм такой?";
		link.l1.go = "second_29";
		break;
		
		case "second_29":
		dialog.text = "Дело в том, что Иезуиты добрались до нашего убежища и полностью вырезали всё мирное население! Не пощадили ни женщин, ни детей.";
		...
		case "second_31":
		dialog.text = "Всё оказывается банально просто. Помнишь того человека, которого ты доставил" + GetSexPhrase("","а") + " ко мне из Тринидада и Тобаго?";
		link.l1 = "Как не помнить, помню, конечно.";
		link.l1.go = "second_32";
		break;
		
		case "second_32":
		dialog.text = "Так вот, это оказался шпион иезуитского ордена. Всё вынюхал, разузнал и передал информацию куда следует.";
		link.l1 = "Так вот почему нам солдаты в Сан-Хосе дали возможность уйти... оказывается, всё шло по заранее запланированному сценарию.";
		link.l1.go = "second_33";
		break;
		
		case "second_33":
		dialog.text = "Да уж, ещё этот негодяй помог сбежать пленённому тобой наемнику, которого мы содержали под арестом.";
		link.l1 = "Знал" + GetSexPhrase("","а") +" бы про такое, убил" + GetSexPhrase("","а") + " бы крысу еще в Сан-Хосе. Значит, и здесь теперь не безопасно, вы так не думаете, Магистр?";
		link.l1.go = "second_34";
		break;
		
		case "second_34":
		dialog.text = "Невозможно заранее просчитать все шаги врагов. Очевидно, они придут и сюда, мы расставили дозорных на случай нежданных гостей, так что спать можно спокойно.";
		link.l1 = "Мм... Это правильно, Магистр, я понимаю ваше негодование, но нельзя раскисать. Мы должны дать адекватный удар Иезуитам, чтобы неповадно было.";
		link.l1.go = "second_35";
		break;
		
		case "second_35":
		dialog.text = "Оптимизма у тебя хоть отбавляй. Каким образом мы это сделаем? У нас остался только один корабль\nХотя, есть неподтверждённая информация, что из Санто-Доминго отходит золотой караван для колонии Картахены\nПоговаривают, что этот конвой состоит из новых кораблей, и что самое интересное - золото будет погружено на новый линейный корабль, прибывший из Старого Света с верфей Испании.";
		link.l1 = "Хм.. тогда почему бы не проверить эту информацию?";
		link.l1.go = "second_36";
		break;
		
		case "second_36":
		dialog.text = "Если тебе удастся эта авантюра, золото лишним не будет, но нам необходимы корабли. Приведи новый линейный корабль с этим золотом, таким образом, мы сэкономим массу времени на приобретение кораблей\nБолее того, такой линейный корабль на местных верфях не купить. Тебе дать в помощь наш корабль?";
		...
		case "second_37":
		dialog.text = "Если то, что мы задумали, удастся - это будет воистину чудо!";
		link.l1 = "...";
		link.l1.go = "Exit";
		NextDiag.TempNode = "second_37";
		break;
		...
		{
	                     PlaySound("VOICE\Russian\QuestMan01.wav");
		dialog.text = "Ну, отчета не нужно - после досмотра твоего судна в порту мне всё уже рассказали... Ты отлично справил" + GetSexPhrase("ся", "ась") + " с поручением\n Великолепно! Это просто великолепно! Какой красивый линейный корабль, просто невероятно! Капитан, мои чувства переполнены, прошу прощения!";
		...
		{
		dialog.text = "Ну, отчета не нужно - после досмотра твоего судна в порту мне всё уже рассказали... Капитан, на корабле не весь груз золота! Я достоверно знал, сколько золота должно было быть\nЭто задание было не только проверкой твоих боевых качеств, но и честности. Испытания на жадность ты не прош" + GetSexPhrase("ёл", "ла") + ". Я не желаю иметь с тобой дел - уходи.";
		link.l1 = "Ну и ладно, будьте здоровы..";
		link.l1.go = "APSGoldConvoy_fail";
		}
		}
		else
		{
		dialog.text = "Что-то я не вижу у тебя в эскадре испанского линейного корабля. Я ведь говорил тебе, что его надо обязательно привести призом. Где он?";
		...
		dialog.text = "Я прекрасно помню, что я говорю, а чего - нет. Ты нарушил условия нашего договора и я более не желаю иметь с тобой дел - проходимцам здесь не место. Уходи.";
		...
		dialog.text = "Зайди ко мне завтра. Мне нужно подумать о том, какую тебе предложить работу. А награду за выполненное поручение получишь завтра от меня лично. До встречи!";
		...
		case "second_40":
	                     PlaySound("VOICE\Russian\QuestMan05.wav");
		dialog.text = "Вот и ты, рад тебя видеть, капитан. Итак, с захваченного корабля часть золота принадлежит тебе, я сразу пересчитал золото в песо, так что твоя доля составляет 774000 песо\nОстальные деньги пойдут на восстановление нашего убежища, а захваченный корабль послужит верой и правдой от агрессивных Иезуитов.";
		link.l1 = "Отлично. Рад" + GetSexPhrase("", "а") + " это слышать.";
		...
		dialog.text = "И от меня лично прими этот скромный подарок. Надеюсь, знаешь как с ним обращаться.";
		link.l1 = "Ого!";
		...
		PlaySound("interface\important_item.wav");
		dialog.text = "...";
		link.l1 = "Спасибо огромное, не ожидал" + GetSexPhrase("", "а") + "... Какие будут дальнейшие действия?";
		...
		case "second_44":
		dialog.text = "Капитан "+pchar.name+", хоть ты и выполнил" + GetSexPhrase("", "а") + " несколько важных поручений, но пока что я не могу раскрыть местонахождение нашего нового убежища. И тем не менее, ты уже в наших рядах на самом высоком положении.";
		link.l1 = "Мм... Понятно.";
		link.l1.go = "second_45";
		break;

		case "second_45":
		dialog.text = "Не расстраивайся, пойми меня правильно, совсем недавно уже вонзили нож в спину, нужно быть настороже\nНа восстановление уйдёт много времени, сам" + GetSexPhrase("", "а") + " понимаешь, строительство, закупка материалов, и много всего остального, в том числе и живая сила\nПоэтому у меня нет желания использовать тебя и твои навыки в этой рутинной области. Несмотря на сложное положение дел, я хочу предложить тебе нечто другое...";
		link.l1 = "Я слушаю.";
		link.l1.go = "second_46";
		break;

		case "second_46":
		dialog.text = "Недаром наш Орден называют тайным, мы собираем по всему миру и в разные времена всё то, что считается мракобесием, изучаем, делаем выводы, записываем в архивы и храним эти знания\nИногда, при необходимости, используем их для достижения определённых целей\nРимская католическая организация знают чем мы обладаем, и за этими знаниями они охотятся по всему миру.";
		link.l1 = "Магистр, давайте ближе к делу.";
		link.l1.go = "second_47";
		break;

		case "second_47":
		dialog.text = "Хорошо. Ты наверняка слышал" + GetSexPhrase("", "а") + ", что на этом острове, более года тому назад, публичной казни был предан известный пират - Чарли Вейн\nОн должен был болтаться в железной клетке еще год, являясь наглядным примером для тех, кто решил заниматься пиратским промыслом\nТак вот, представьте себе - тело Вейна исчезло из клетки... И в тот же день были убиты один из местных священников Порт Рояля и несколько самых прилежных прихожан. Странное совпадение, не правда ли?";
		link.l1 = "Хм, разве нам не наплевать на смерть этих священников, пусть хоть всех их...";
		...
		link.l1 = "Прошу прощения, Магистр, вы правы. Итак, вы хотите, чтобы я разузнал" + GetSexPhrase("", "а") + " об этом исчезновении Чарли Вейна?";
		...
		link.l1 = "Тогда придётся найти его и поговорить с ним.";
		link.l1.go = "second_50";
		break;

		case "second_50":
		dialog.text = "Это вряд ли... Он накинул себе пеньковый галстук прямо у себя дома. Говорить нужно с представителем церкви. Действуй! И не затягивай с этим делом, по окончании расследования приходи!";
		link.l1 = "Отлично. Спасибо, я всё понял" + GetSexPhrase("", "а") + ".";
		link.l1.go = "Exit";
		...
		case "second_55":
	                     PlaySound("VOICE\Russian\QuestMan01.wav");
		dialog.text = "Приветствую, капитан, есть что-нибудь по Чарли Вейну?";
		link.l1 = "Приветствую вас, Магистр. Кое-что имеется...";
		link.l1.go = "second_56";
		break;

		case "second_56":
		dialog.text = "Я слушаю.";
		link.l1 = "История довольно длинная, если в общих чертах...";
		link.l1.go = "second_57";
		break;

		case "second_57":
		dialog.text = "...";
		link.l1 = "Чарли Вейн имел древнюю каменную табличку, от которой со слов бывшего священника у него поехала крыша, демоны во сне, чудики и всякая чепуха. По-моему крышу ему сорвали убийства невинных людей в одной из старых деревень на острове Синт-Маартен. А тело Вейна сняли ночью и захоронили где-нибудь недалеко от Порт-Рояля и раздули очередную байку о живых мертвецах...";
		link.l1.go = "second_58";
		break;

		case "second_58":
		dialog.text = "Может быть, ты и прав" + GetSexPhrase("", "а") + ", лично у меня на этот счёт другое мнение. Ты там был" + GetSexPhrase("", "а") + ", в этой деревне?";
		link.l1 = "Да, Магистр, я там был" + GetSexPhrase("", "а") + ", осмотрел" + GetSexPhrase("ся", "ась") + ", кроме развалин, старой разваленной церкви и склепов с захоронениями там ничего нет.";
		link.l1.go = "second_59";
		break;

		case "second_59":
		dialog.text = "Ты говорил" + GetSexPhrase("", "а") + " о табличке, она у тебя?";
		...
		case "second_061":
		dialog.text = "Этой табличке несколько тысяч лет, принадлежность этого артефакта уходит в очень далёкие времена. Вот что, приходи завтра, мне нужно посмотреть свои архивы и сравнить некоторые данные по этому артефакту. Ты молодец.";
		link.l1 = "Спасибо! Хорошо, как скажете, зайду завтра.";
		link.l1.go = "Exit";
		...
		case "second_62":
	                     PlaySound("VOICE\Russian\QuestMan01.wav");
		dialog.text = "Всё сходится, эту табличку тебе нужно показать одним людям, которые владеют глубокими знаниями. Это очень интересные люди, они, как и мы, закрыты для многих. Но мы с ними как-то пересекались, теперь тебе выпал шанс познакомиться с ними.";
		link.l1 = "Что это за люди?";
		...
		PlaySound("interface\important_item.wav");
		dialog.text = "Ты сам" + GetSexPhrase("", "а") + " всё узнаешь от них. Забери табличку, найди человека по имени Миксер. Их группа изучают культуру древних народов, их можно найти на острове Тринидад и Тобаго в заливе Маяро, там они обнаружили древнюю пирамиду, очень древнюю. Отдай эту табличку им, этот артефакт для них горазда полезнее, чем для кого-либо.";
		link.l1 = "Понял" + GetSexPhrase("", "а") + ", а что насчёт...";
		...
		dialog.text = "Я помню, вот за труды твои...";
		...
		case "GothicApostatesAPS_quests_ship":
	                     PlaySound("VOICE\Russian\QuestMan01.wav");
		dialog.text = "Надеюсь, я подошёл вовремя? Теперь я полностью тебе доверяю. После предательства Филипа Бличера, которого ты привез" + GetSexPhrase("", "ла") + ", у меня были подозрения, что ты с ним заодно. Но теперь все мои сомнения развеяны.";
		link.l1 = "Магистр, я это понял" + GetSexPhrase("", "а") + ", когда приш" + GetSexPhrase("ел", "ла") + " к ростовщику в последний раз, кстати, его зарезали Иезуиты, я был" + GetSexPhrase("", "а") + " свидетелем этого убийства.";
		link.l1.go = "GothicApostatesAPS_quests_ship_1";
		break;

		case "GothicApostatesAPS_quests_ship_1":
		dialog.text = "Вот черти.. говорил я ему уходить с нами, так он ни в какую, мол, его не посмеют тронуть в городе. Жаль, нам нужно многое обсудить, давай встретимся в нашем убежище, за то время пока тебя не было, мы кое в чём преуспели\nНадеюсь, мой подарок ещё у тебя? По этим координатам найдёшь остров, там наше убежище. Так что иди в свою каюту и проложи курс, встретимся в моём кабинете. При подходе к поселению на острове не забудь сменить флаг на чёрный, дружественный.";
		...
		link.l1 = "Выглядит довольно маленьким, но, я правильно понимаю, это только начало?";
		link.l1.go = "second_71";
	                     //AddDialogExitQuestFunction("GothicApostatesAPS_SanAndres");
		break;

		case "second_71":
		dialog.text = "Именно, но на это нужны средства! То, что ты взял" + GetSexPhrase("", "а") + " призом, хватило только на этот порт, форт и пару домов, но весь остров в нашем распоряжении. Поселение будем развивать и дальше, построим достойную колонию, независимую от держав, и им придётся с нами считаться.";
		link.l1 = "Отлично. Но где взять такие огромные деньги? Топить корабли, убивать людей, грабить другие поселения ради того, чтобы процветать самим?";
		link.l1.go = "second_72";
		break;

		case "second_72":
		dialog.text = "Конечно же нет, средства можно заработать и другими способами. Среди нашего сообщества есть люди, обладающие не только знаниями, но и разными умениями, одни могут видеть намного глубже и дальше, другие могут чувствовать утончённо\nЯ и сам обладаю некоторыми способностями ясновидения. Многие из нас имеют огромные деньги, но, к сожалению, все они находятся в разных концах света\nОракул, один из немногих богатейших людей, покинул Европу и перебрался жить в Россию подальше от назойливых Иезуитов. Другие находятся в Африке, ну а я перебрался сюда. Остальные ведут тихий образ жизни в европейских странах, многие из них имеют доступ к Королям, имеют высокие чины и сами по себе богатые и влиятельные люди, готовые платить большие суммы за древние артефакты и знания.";
		link.l1 = "И где же взять эти артефакты?";
		link.l1.go = "second_73";
		break;

		case "second_73":
		dialog.text = "Разумеется, здесь, в Карибском бассейне. Культура индейских племен довольно древняя, очень много предметов их быта, а также различных артефактов находятся на этом архипелаге, нужно только знать, где их искать.";
		link.l1 = "Хм, и в этом помогут как раз ваши способности ясновидения?";
		link.l1.go = "second_74";
		break;

		case "second_74":
		dialog.text = "В точку. Кстати, ты разобрал" + GetSexPhrase("ся", "ась") + " в истории с Чарли Вейном?";
		link.l1 = "Да, Магистр, до сих пор поджилки трясутся.";
		link.l1.go = "second_75";
		break;

		case "second_75":
		dialog.text = "Что ж.. Значит ты " + GetSexPhrase("тот", "та") + ", кому предназначено судьбой вершить суд над приспешниками ада. Чарли Вейн говорил с тобой?";
		...
		link.l1 = "Хотел моей смерти, говорил, что только я могу помешать его планам..";
		link.l1.go = "second_77";
		break;

		case "second_77":
		dialog.text = "Значит, несомненно, ты " + GetSexPhrase("тот", "та") + " о ком я думаю.";
		link.l1 = "И кто же я по-твоему?";
		link.l1.go = "second_78";
		break;

		case "second_78":
		dialog.text = "Ты Хранитель. Хранители родились ещё задолго до Шумерской цивилизации, твой дух не знает покоя.";
		link.l1 = "Ого, неожиданно.. Кем меня уже только не называли за время моего пребывания здесь, но хранителем - впервые.";
		link.l1.go = "second_79";
		break;

		case "second_79":
		dialog.text = "Демоны и нечисть будут искать способ, чтобы в мире живых овладеть тобой, наверное, ты им очень нравишься. С помощью тебя они смогут сделать скверные вещи.";
		link.l1 = "Есть ли еще такие же, как и я? Хранители, имею ввиду.";
		link.l1.go = "second_80";
		break;

		case "second_80":
		dialog.text = "Разумеется, ты не " + GetSexPhrase("один такой", "одна такая") + ", с таким даром. Вас можно пересчитать на пальцах. Тем не менее, я вижу перед собой одного из Хранителей, невероятно...";
		link.l1 = "Хорошо... С чего мы начнём? Где будем искать артефакты?";
		link.l1.go = "second_81";
		break;

		case "second_81":
		dialog.text = "Дай мне время, мне необходимо сосредоточиться... Зайди ко мне завтра, возможно, я увижу более яркую картину и смогу понять, что нам делать дальше.";
		link.l1 = "Договорились. До завтра, Магистр.";
		link.l1.go = "Exit";
		...
		case "second_90":
		dialog.text = "...";
		link.l1 = "Приветствую тебя, Магистр, ну как, есть какие-то новости?";
		link.l1.go = "second_91";
		break;

		case "second_91":
	                     PlaySound("VOICE\Russian\QuestMan01.wav");
		dialog.text = "Рад видеть тебя, Хранитель. Да, меня заинтересовала одна история, связанная с реинкарнацией, на которой я и сосредоточился. Из поселения индейцев племени Шаганумби ловцы жемчуга выловили человека в море, на его лице был страх и ужас, думали, это у него лихорадка - он кричал, бился в судорогах.\nИндейцы провели ритуал над ним, он стал приходить в себя и рассказал о том, что с ним случилось.\nКак оказалось, он моряк, ходил вместе с капитаном Делвином Блейзом на бриге 'Удачливый Джокер'. На их корабле стали происходить страшные вещи... все члены команды при лунном свете стали выглядеть как живые мертвецы, напоминающие зомби или скелетов. От увиденного он и решил выпрыгнуть за борт и пробыл в море около десяти дней. Я сосредоточился на этой истории и кое-что удалось понять и разглядеть. Картина не очень ясная... Но стоит проверить.";
		link.l1 = "Очень загадочная история. И как успехи? Удалось что-то увидеть?";
		link.l1.go = "second_92";
		break;

		case "second_92":
		dialog.text = "Я увидел человека, на которого охотятся приспешники демона, с которым ты имел честь разговаривать. Это очень древний демон, изгнанный из своего обиталища.\nОн очень могущественен, и уничтожить его невозможно, однако его можно остановить на некоторое время, а для этого необходимо понять чего он добивается. Эти события - звенья одной цепи, в этом нет сомнения.";
		link.l1 = "Понятно... И где же искать того, на кого он охотится?";
		link.l1.go = "second_93";
		break;

		case "second_93":
		dialog.text = "Эспаньола, и ещё я видел маяк. К сожалению, больше ничего конкретного..";
		link.l1 = "Хм, на Эспаньоле два маяка, стоит проверить оба.";
		link.l1.go = "second_94";
		break;

		case "second_94":
		dialog.text = "Удачи! Я пока займусь изучением этого вопроса дальше, возможно, раскопаю что-нибудь ещё.";
		link.l1 = "Хорошо.";
		link.l1.go = "Exit";
		...
		case "second_95":
		dialog.text = "Да пребудут с тобой силы, Хранитель.";
		link.l1 = "...";
		link.l1.go = "Exit";
		NextDiag.TempNode = "second_95";
		break;
		...
		case "second_96":
	                     PlaySound("VOICE\Russian\QuestMan01.wav");
		dialog.text = "Приветствую тебя, Хранитель, ну как, проверил маяки на Эспаньоле?";
		...
		case "second_108":
		dialog.text = "Миксер уже должен был вернуться домой из храма, его дом находится на Мартинике, там чуть ли не целая библиотека. Да пребудут с тобой силы, Хранитель.";
		link.l1 = "...";
		link.l1.go = "Exit";
		...
		case "second_174":
		dialog.text = "Да пребудут с тобой силы, Хранитель. Могу вас заверить,что рай существует. Ведь сейчас мы не умолимо катимся в ад.";
		link.l1 = "Спасибо.";
		link.l1.go = "Exit";
		NextDiag.TempNode = "second_174";
		break;
...
//********************* Член ордена масонов*****************************
	...
	case "Mason_2":
	dialog.text = "Капитан, по указанию Магистра, мы его забираем к себе, тебе же надо срочно прибыть к нему.";
...
//*********************Банкир*****************************
		...
		case "usurerSavLaMar":
		dialog.text = "...";
		link.l1 = "Я тебя предупреждал" + GetSexPhrase("", "а") + ", с этими ребятами шутки плохи!";
		link.l1.go = "usurerSavLaMar_1";
		break;

		case "usurerSavLaMar_1":
		dialog.text = "Не могу поверить, чтобы священники были садистами, значит, я правильно выбрал сторону, и ни о чём не сожалею.";
		link.l1 = "Давай выбираться отсюда, скоро здесь всё сгорит до тла, можешь идти?";
		link.l1.go = "Exit";
...
//*********************Роберт Блэйк*****************************
		...
		case "RobertBlake_1":
		dialog.text = "Вот чёрт, это я с перепугу.. Чего ты хочешь?";
		link.l1 = "Успокойся... Ты ведь ходил несколько лет под командованием Чарли Вейна, не так ли?";
		...
		link.l1 = "Я знаю о его судьбе. Лучше скажи мне, было ли у Чарли какое-то свое любимое место, которое он часто навещал?";
		...
		link.l1 = "Любимое местечко?";
		link.l1.go = "RobertBlake_4";			
		break;

		case "RobertBlake_4":
		dialog.text = "Да, было у него одно местечко - не знаю, чем оно так ему приглянулось - его словно тянуло туда.";
		link.l1 = "Что это за место, говори!";
		link.l1.go = "RobertBlake_5";			
		break;

		case "RobertBlake_5":
		dialog.text = "Это место - залив Грейт. Находится около Синт-Маартена, там ещё есть старая заброшенная деревня, было неплохим укрытием для пиратов какое-то время\nВот там Вейн и покуралесил от души, нравилось ему это место, но в итоге его команда вырезала всех местных жителей, после чего у Вейна поехала крыша. Удачи тебе, капитан!";
...
//*********************Чарли Вейн*****************************
		...
		dialog.text = "...";
		link.l1 = "Неужели ты всё это запланировал?";
		link.l1.go = "SharliVein_2";			
		break;

		case "SharliVein_2":
	                     PlaySound("VOICE\Russian\SharliVein\HELLO_3.wav");
		dialog.text = "Ах-ха-ха, что ты знаешь о моих намерениях, смертный?";
		link.l1 = "...";
		...
		dialog.text = "Единственный, кто мог бы мне помешать в моих замыслах - это ты. И здесь тебе никто не поможет.";
...
//************Одержимые  Билл Метью****************************************
		...
		dialog.text = "Спасибо, что помогли мне, без вас они бы убили меня и забрали эту чёртову монету.";
		link.l1 = "Что за монету? Зачем скелетам деньги?";
		link.l1.go = "BillMatthew_1";		
		break;
		
		case "BillMatthew_1":
		dialog.text = "Это не простая монета. Пожалуй, мне стоит рассказать вам всю историю. Я был штурманом в команде Делвина Блейза на пиратском бриге 'Удачливый Джокер'.\nПосле удачного рейда на испанский галеон, забитый всякими индейскими украшениями, золотом и серебром, помимо драгоценностей, мы нашли шкатулку, в которой лежали пузырек с какой-то жидкостью и три старинные золотые монеты.\nРаньше никто из нас таких монет не видел. Мы поделили монеты, и одна из них досталась мне, а шкатулка с жидкостью - капитану.";
		link.l1 = "Хм, и что же было дальше?";
		link.l1.go = "BillMatthew_2";		
		break;

		case "BillMatthew_2":
		dialog.text = "Через какое-то время капитану Блейзу удалось найти человека, который смог прочитать надпись на крышке той самой шкатулки.\nОказалось, что обладатель содержимого мог связаться со злыми индейскими духами, прочитав заклинание, написанное на крышке, и смешав свою кровь с жидкостью из пузырька.\nНаш капитан так и сделал, в результате чего в него вселился злой дух! Более того, Блейз получил необъяснимую власть над своей командой, а часть своих матросов с помощью этой колдовской жидкости превратил в живых скелетов!\nНо на меня не подействовали его чары, теперь я понимаю почему - эта старинная монета спасла меня! Через какое-то время мне удалось сбежать, я сменил род деятельности, по ходатайству тестя меня взяли штурманом на торговое судно.\nБеда вот в чём - чем больше людей Блейз и его команда убивают, тем сильнее он становится.";
		link.l1 = "Какой кошмар.. Я знаю, что это за демон, его нужно немедленно остановить. Но откуда взялись эти скелеты, которые пытались тебя убить?";
		link.l1.go = "BillMatthew_3";		
		break;

		case "BillMatthew_3":
		dialog.text = "Не перебивайте! Для каких-то целей ему необходимы все три монеты. Одна из монет досталась первому помощнику Блейза при дележе. На следующий день мы не досчитались одного из команды, как ни странно, им оказался именно первый помощник.";
		link.l1 = "Даже думать не хочу, что он с ним сделал.. Погоди-ка, а в тот день вы были у берегов Доминики?";
		link.l1.go = "BillMatthew_4";		
		break;

		case "BillMatthew_4":
		dialog.text = "Да, а как вы догадались?";
		link.l1 = "Его спасли аборигены, ловцы жемчуга, как рассказал мне Магистр. Продолжай...";
		link.l1.go = "BillMatthew_5";		
		break;

		case "BillMatthew_5":
		dialog.text = "Какой Магистр? Впрочем ладно, не моего ума это дело... Гореть в аду этому Блейзу, на его шее красовалась эта монета, и он всех убедил, что Абрам, первый помощник, отдал ему её добровольно, а сам решил уйти из команды. Значит, всё верно, он забрал монету силой и выбросил моряка в море, никак не иначе. Чутьё нас не подвело, я и квартирмейстер решили покинуть корабль.";
		link.l1 = "Как я понимаю, обладателем второй монеты был квартирмейстер?";
		link.l1.go = "BillMatthew_6";		
		break;

		case "BillMatthew_6":
		dialog.text = "Да, Юмбер Кёруа, он живет в Капстервиле и, похоже, ему тоже грозит опасность.";
		link.l1 = "Понятно.. Чем-то еще тебе помочь?";
		...
		link.l1 = "Да, так и есть, в худшем случае они застанут тебя одного и прирежут.";
		...
		PlaySound("interface\important_item.wav");
		dialog.text = "Капитану Блейзу необходимы все три золотые монеты Инков! Знаете что, капитан, возможно, вам удастся победить в этой войне с духами, демонами и другой нечистью! Меня же точно убьют... и тогда представить страшно, что может случиться. Заберите эту монету, пожалуйста, я хочу наконец начать жить спокойно.";
		link.l1 = "Ну что ж, давай сюда эту монетку, я постараюсь разобраться что к чему. Желаю тебе поскорее забыть об этих мертвецах и демонах и начать жить спокойной жизнью. Удачи.";
		link.l1.go = "exit";	

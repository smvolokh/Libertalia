...
void CharactersInit()
{
	...
	LoadSegment(sPath + "init\Dominica.c");				ReloadProgressUpdate();
	...
	UnloadSegment(sPath + "init\Dominica.c");
...
void SetOverloadNormWalk(ref character)
{
	...
	if (character.model == "protocusto" && !CheckAttribute(character, "CSM.FreeRun"))
	{
		character.actions.walk = "walk";
		character.actions.backwalk = "back walk";
		character.actions.run = "walk";
...
void CheckAndSetOverloadMode(ref character)
{
	...
	if(character.model == "monkey")
	{
		DeleteAttribute(character, "actions.walk");
		DeleteAttribute(character, "actions.backwalk");
		DeleteAttribute(character, "actions.run");
		DeleteAttribute(character, "actions.backrun");	
		DeleteAttribute(character, "actions.stsUp");
		DeleteAttribute(character, "actions.stsUpRun");
		DeleteAttribute(character, "actions.stsDown");
		DeleteAttribute(character, "actions.stsDownRun");
		DeleteAttribute(character, "actions.fightwalk");
		DeleteAttribute(character, "actions.fightbackwalk");
		DeleteAttribute(character, "actions.fightrun");
		DeleteAttribute(character, "actions.fightbackrun");	
		
		character.actions.walk = "walk";
		character.actions.backwalk = "back walk";
		character.actions.run = "walk";
		character.actions.backrun = "back walk";
		character.actions.stsUp = "walk";
		character.actions.stsDown = "walk";
		character.actions.stsUpBack = "back walk";
		character.actions.stsDownBack = "back walk";
		character.actions.stsUpRun = "walk";
		character.actions.stsDownRun = "walk";
		character.actions.stsUpRunBack = "back walk";
		character.actions.stsDownRunBack = "back walk";
		character.actions.turnLeft = "skip";
		character.actions.turnRight = "skip";
		character.actions.swim = "walk";	
		character.actions.fightwalk = "walk";
		character.actions.fightbackwalk = "back walk";
		character.actions.fightrun = "walk";
		character.actions.fightbackrun = "back walk";
	}
